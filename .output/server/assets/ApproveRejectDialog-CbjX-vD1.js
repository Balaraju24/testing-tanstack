...
import { f as fileUploadAPI, u as uploadToS3API, a as uploadDocumentAPI, i as updateDocumentAPI } from "./fileUpload-BBm5-XTb.js";
import { s as sliceFilename } from "./manage-CWSyPq63.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, f as DialogDescription, g as DialogFooter } from "./dialog-CbaK730S.js";
...
const FileUpload = ({
  ...
  const { mutate: getPresignedUrls } = useMutation({
    ...
    onError: (error) => {
      if (error.response?.status === 422 && error.response?.data?.errData?.file_size) {
  ...
  const getFilePreview = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "text-sm flex items-center justify-center", children: sliceFilename(selectedFile?.name, 25) }),
      /* @__PURE__ */ jsxs("div", { className: "bg-gray-100 p-6 mt-4", children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx(File, { size: 70 }) }),
        /* @__PURE__ */ jsx("p", { className: "text-base mt-4", children: "No Preview Available" }),
        /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500 flex items-center justify-center", children: selectedFile && /* @__PURE__ */ jsxs("p", { children: [
    ...
    DialogContent,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-5 mt-4", children: [
          ...
          dialogType?.verification_status === "REJECTED" ? /* @__PURE__ */ jsx(
            Button,
            {
              onClick: onConfirm,
