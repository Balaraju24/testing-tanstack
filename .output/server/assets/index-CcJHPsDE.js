...
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-8VPYQ3UR.js";
import { B as Button, c as cn } from "./router-e7zdrxGz.js";
import { C as Calendar } from "./calendar-BN2MwFmY.js";
import { CalendarIcon, Loader, Smartphone, Mail, Upload, ChevronRight, ArrowLeft, Loader2 } from "lucide-react";
import { L as LoadingComponent } from "./Loading-DQypZbMn.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-CbaK730S.js";
import { T as Textarea } from "./textarea-BfKn0GZN.js";
import { C as CalendarIcon$1 } from "./calendar-icon-LEoQxdpF.js";
import { T as Todo } from "./Todo-9fPLLx5K.js";
import { c as caseViewNotesAPI } from "./manage-tW0NLyej.js";
import { s as sendPaymentLink, c as casePaymentDocAPI, a as singleServiceAPI, b as caseNextHearingDateAPI } from "./service-1g9dZr4o.js";
import { a as formatDate, s as sliceFilename } from "./manage-CWSyPq63.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DdHLlHy_.js";
...
import { N as NotesHeadIcon } from "./notes-head-icon-BuoOTi3l.js";
import { S as Sheet, e as SheetTrigger, a as SheetContent, b as SheetHeader, c as SheetTitle, f as SheetClose } from "./sheet-vrO17VYZ.js";
...
import { L as Label } from "./label-Btl29BJR.js";
...
function DatePicker({ onDateSelect, caseDetails }) {
  ...
  return /* @__PURE__ */ jsxs(Popover, { open: isOpen, onOpenChange: setIsOpen, children: [
    caseDetails?.status === "CLOSURE" ? /* @__PURE__ */ jsx("span", { className: "text-xs", children: "Next hearing" }) : /* @__PURE__ */ jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
      Button,
      {
        variant: "outline",
        className: cn(
        ...
        children: [
          /* @__PURE__ */ jsx(CalendarIcon, { className: "h-3.5 w-3 mr-0" }),
...
const DetailsCard = ({ details }) => {
  ...
  const { serviceData } = UseContextAPI();
  const isLitigation = serviceData?.service_type === "Litigation";
  const assignedAdvocates = details?.advocate_cases?.filter(
    (advocateCase) => advocateCase.is_advocate_assigned
  ) || [];
  const selectedAdvocate = assignedAdvocates[selectedAdvocateIndex]?.advocate || null;
  const createIcon = (iconKey) => issueIcons[iconKey]?.({ className: "h-5 w-5 text-black mx-1" }) ?? /* @__PURE__ */ jsx("span", { role: "img", "aria-label": "icon", children: "📄" });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border border-gray-300 rounded-none bg-white overflow-hidden text-sm", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-[#F0F4FA] p-3 space-y-1 border border-gray-300 ", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: details?.created_at ? dayjs(details?.created_at).format("DD MMM YYYY") : null })
      ] }),
      ...
      Tabs,
      {
        ...
        children: isLitigation ? /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
          ...
          (isManager() || isAdvocate() || isAdmin()) && /* @__PURE__ */ jsx(TabsContent, { value: "client", className: "mt-0", children: /* @__PURE__ */ jsx(
            UserCardMini,
            {
              name: (details?.user?.first_name ?? "") + (details?.user?.last_name ? " " + details?.user?.last_name : ""),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            (isManager() || isUser() || isAdmin()) && /* @__PURE__ */ jsx(TabsContent, { value: "lawyer", className: "", children: /* @__PURE__ */ jsx("div", { className: "space-y-3 text-sm text-gray-800", children: /* @__PURE__ */ jsx(
              UserCardMini,
              {
                name: selectedAdvocate ? `${selectedAdvocate?.first_name ?? ""} ${selectedAdvocate?.last_name ?? ""}`.trim() || "--" : "Not assigned",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex gap-1 items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center text-xs border border-gray-400 gap-1 p-1 bg-white", children: [
            "Next Hearing :",
            /* @__PURE__ */ jsx("div", { children: formatDate(record?.next_hearing_date) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "text-xs", children: dayjs(record?.next_hearing_date).format("h:mm a") })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-x-2", children: /* @__PURE__ */ jsx("div", { className: "text-xs text-black", children: record?.updated_at === null ? formatDate(record?.created_at) : formatDate(record?.updated_at) }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "space-y-1 my-2", children: /* @__PURE__ */ jsx("div", { className: "text-xs 3xl:text-sm text-gray-600 list-none font-normal", children: record?.note.split("\n").map((note, index) => /* @__PURE__ */ jsxs(
        "div",
        {
...
const ServiceViewComponent = () => {
  ...
  const activateFinalHearing = caseStagesData?.stages?.find((sub) => sub.code === "CSFG") && caseStagesData?.stages?.find((sub) => sub.code === "CSFG")?.status === "completed";
  const deactivatedFinalHearing = caseStagesData?.stages?.find(
    (sub) => sub.code === "TRPH"
  ) ? caseStagesData?.stages?.find((sub) => sub.code === "TRPH")?.status === "completed" : caseStagesData?.stages?.find((sub) => sub.code === "CTPG")?.status === "completed";
  const {
    isLoading,
    ...
    queryFn: async () => {
      try {
        ...
        if (response.status === 403) {
          ...
          toast.error(response?.data?.message, { duration: 4e3 });
        }
      } catch {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 max-w-full overflow-hidden", children: [
          /* @__PURE__ */ jsxs("p", { className: "hidden lg:flex items-center m-0", children: [
            ...
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-black font-normal bg-[#F2F2F2] px-1.5 mx-1 text-xs 3xl:text-base ", children: singleServiceDetails?.temp_id })
          ] }),
          serviceData?.cnr_number && /* @__PURE__ */ jsxs("p", { className: "hidden lg:flex items-center m-0", children: [
            /* @__PURE__ */ jsx("span", { className: "text-black pr-1 text-opacity-80 font-normal text-[11px] 3xl:text-sm", children: "CNR Number :" }),
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-black font-normal  bg-[#F2F2F2] px-2  text-xs 3xl:text-base", children: serviceData?.cnr_number })
          ] }),
          serviceData?.cmp_number && /* @__PURE__ */ jsxs("p", { className: "hidden lg:flex items-center m-0", children: [
            /* @__PURE__ */ jsx("span", { className: "text-black pr-1 text-opacity-80 font-normal text-[11px] 3xl:text-sm", children: "CMP Number :" }),
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-black font-normal  bg-[#F2F2F2] px-2  text-xs 3xl:text-base", children: serviceData?.cmp_number })
          ] })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[25%_75%] space-x-4 h-[calc(100vh-135px)] relative", children: [
      /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 h-full overflow-y-auto relative hearingdate", children: [
          ...
          serviceData?.service_type === "Legal opinion" && /* @__PURE__ */ jsxs("div", { className: "bg-gray-100 border rounded-none border-gray-400 p-2 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(CalendarIcon$1, { className: "h-4 w-4 text-gray-600" }),
            /* @__PURE__ */ jsxs("span", { className: "text-sm font-normal text-gray-800", children: [
              "Due Date :",
              " ",
              /* @__PURE__ */ jsx("span", { className: "text-gray-600 font-normal", children: serviceData?.due_date ? dayjs(serviceData?.due_date).format("DD MMM YYYY") : "--" })
            ] })
          ] }),
          serviceData?.service_type === "Litigation" && /* @__PURE__ */ jsx("div", { children: activateFinalHearing && /* @__PURE__ */ jsxs("div", { className: "p-2 bg-[#F0F4FA] font-normal space-y-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-between items-center gap-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 lg:text-xs xl:text-base 2xl:text-lg 3xl:text-xl", children: isUser() || deactivatedFinalHearing ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs 2xl:text-sm truncate max-w-[180px]", children: singleServiceDetails?.next_hearing_date ? dayjs(
            ...
            nextHearingNotes?.pages?.[0]?.data?.[0]?.note && /* @__PURE__ */ jsx("div", { className: "w-full text-xs 3xl:text-sm text-gray-600 font-normal", children: /* @__PURE__ */ jsx(
              NoteWithShowMore,
              {
                notes: nextHearingNotes?.pages?.[0]?.data?.[0]?.note || ""
              }
            ) })
          ] }) })
        ] }),
