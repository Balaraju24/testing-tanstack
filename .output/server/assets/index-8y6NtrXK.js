...
import { g as getAllLocationsAPI, e as editLocationAPI, C as CreateLocationAPI, d as deleteLocationAPI, t as toggleStatusLocationAPI } from "./location-D_tPNO3m.js";
import { a as addSerial } from "./app-CEOvaEAI.js";
import { useQuery, useMutation } from "@tanstack/react-query";
import { useLocation } from "@tanstack/react-router";
import dayjs from "dayjs";
import { Loader2, Edit2Icon, X, PlusIcon } from "lucide-react";
...
const Locations = () => {
  ...
  const dataWithOptimisticUpdates = locationsData?.records?.map((record) => ({
    ...record,
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-hidden pl-0 mt-2", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-sm border border-gray-300 flex flex-col px-2", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsx(
        TanStackTable,
        {
          ...
          paginationDetails: locationsData?.pagination_info || {
