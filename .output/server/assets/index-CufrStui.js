...
import { v as vettingDocumentsAPI, r as receivedDocumentsAPI } from "./legalOpinion-qNiAW4Gj.js";
import { i as isSubStageCompleted, M as ManageCaseHeader } from "./ManageCaseHeader-B1x76cDH.js";
import { h as downloadSingleDocAPI, u as uploadToS3API, a as uploadDocumentAPI, f as fileUploadAPI } from "./fileUpload-BBm5-XTb.js";
...
const useDocumentOperations = (serviceId, stage, subStage) => {
  ...
  const { mutate: mutateDownloadFile, isPending: isPendingDownloadFile } = useMutation({
    mutationFn: async (payload) => {
      ...
      if (response?.data?.status === 200 && response?.data?.data?.download_url) {
        downloadFileFromS3(
    ...
    try {
      for (const fileData of uploadedFiles) {
        ...
        await uploadDocumentAPI({
          ...
          category: serviceData?.is_received_original_doc ? "Final Report Document" : "Legal Report Document"
        });
      }
...
const ReportSubmissions = ({ stage, subStage }) => {
  ...
  const advocateName = `${serviceData?.advocate_cases?.[0]?.advocate?.first_name || ""} ${serviceData?.advocate_cases?.[0]?.advocate?.last_name || ""}`.trim();
  ...
  const showFinalUploadUI = serviceData?.is_received_original_doc && uploadedFiles.length === 0 && !hasFinalDocs;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-full relative bg-white", children: [
    /* @__PURE__ */ jsx(
      ManageCaseHeader,
      {
        ...
        showActionButton: !isUser() && (allDocsData?.length === 2 || allDocsData?.length === 1 && isCurrentStageCompleted && !localVettingState),
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-4 py-2", children: [
      ...
      hasExistingDocs && !(isCurrentStageCompleted && !serviceData?.vetting_of_doc) && /* @__PURE__ */ jsx("div", { className: "bg-blue-50 p-2 rounded mt-2", children: serviceData?.vetting_of_doc ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "checkbox",
      ...
      serviceData?.vetting_of_doc && /* @__PURE__ */ jsx("div", { className: "bg-blue-50 p-2 rounded mt-2", children: /* @__PURE__ */ jsxs("label", { className: "flex items-center space-x-2 cursor-pointer", children: [
        isPendingReceived ? /* @__PURE__ */ jsx(Loader2, { className: "w-5 h-5 text-black animate-spin" }) : /* @__PURE__ */ jsx(
          "input",
          {
            ...
            disabled: isPendingReceived || !isAdvocate() || allDocsData?.length === 2
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: !isAdvocate() && serviceData?.is_received_original_doc ? `Received original documents by ${advocateName}` : "Received original documents"
            }
          ),
          !isAdvocate() && !serviceData?.is_received_original_doc && /* @__PURE__ */ jsx("div", { className: "text-[11px] 2xl:text-xs  text-gray-500", children: "Only advocates can perform this action" })
        ] })
      ] }) }),
      ...
      serviceData?.is_received_original_doc && !showFinalUploadUI && /* @__PURE__ */ jsx(
        DocumentList,
        {
          documents: allDocsData.filter(
