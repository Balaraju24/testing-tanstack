...
import { CalendarIcon, X, ChevronLeft, ChevronDown, ChevronRight, Check, Circle, Loader2, PlusIcon, Search } from "lucide-react";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-8VPYQ3UR.js";
import { g as generateYears, b as getDaysInMonth, e as extractKeyFromUrl } from "./app-CEOvaEAI.js";
...
import { C as Card } from "./card-CfZVGcIr.js";
...
import { C as Command, a as CommandInput, b as CommandList, d as CommandGroup, e as CommandItem, c as CommandEmpty } from "./command-DoJaARCj.js";
...
import { s as singleManagerAPI, d as singleAdvocateAPI, e as addManagerAPI, f as addAdvocateAPI, u as updateManagerAPI, h as updateAdvocateAPI } from "./advocate-Cvw6EtWS.js";
import { a as getAllLocationsListAPI } from "./location-D_tPNO3m.js";
import { q as qualifications } from "./advocate-DLfkmGnv.js";
import { s as stateOptions } from "./stateConstants-CKjWDC1S.js";
import { d as deletePayload } from "./deletePayload-CnkJRSrW.js";
...
function DateOfBirthPicker({
  ...
  const [date, setDate] = React.useState(value ?? void 0);
        ...
        selectedItems.length === 0 ? "Select Area Of Interest" : selectedItems.slice(0, 4).map((value2) => {
          ...
          return /* @__PURE__ */ jsxs(
            "span",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { className: `truncate flex-1 ${color} `, children: item?.label }),
                /* @__PURE__ */ jsx(
                  X,
                  {
...
const MultiSelectLocations = ({
  ...
  const filteredLocations = locations?.filter(
    (location2) => location2?.name?.toLowerCase()?.includes(locationSearch.toLowerCase())
  );
  const toggleValue = (itemValue) => {
          ...
          value.length === 0 ? "Select Work Location" : value.slice(0, 4).map((id) => {
            ...
            return /* @__PURE__ */ jsxs(
              "span",
              {
                ...
                style: { backgroundColor: background },
                children: [
                  /* @__PURE__ */ jsx("span", { className: "truncate flex-1", children: item?.name || "Unknown" }),
                  /* @__PURE__ */ jsx(
                    X,
                    {
                      className: "cursor-pointer text-red-600 w-4 h-4 flex-shrink-0",
...
const CreateAdvocate = () => {
  ...
  const { mutate: mutateAddAdvocate, isPending: isLoadingAddAdvocate } = useMutation({
    ...
    mutationFn: async (formData2) => {
      ...
      if (shouldUseSingleSelection && formData2.state) {
        const stateName = stateOptions.find((state) => state.code === formData2.state)?.name || formData2.state;
  ...
  const { mutate: mutateUpdateAdvocate, isPending: isLoadingUpdateAdvocate } = useMutation({
    ...
    mutationFn: async (data) => {
      ...
      if (shouldUseSingleSelection && data.state) {
        const stateName = stateOptions.find((state) => state.code === data.state)?.name || data.state;
  ...
  const handleUpdateSubmit = (e) => {
    ...
    const updatedFormData = {
      ...
      designation: formData.designation?.trim() === "" ? null : formData.designation,
  ...
  useEffect(() => {
    if (advocateData) {
      ...
      if (isEditingManager) {
        ...
        locationIds = advocateData.advocate_locations?.map((loc) => loc.location_id) || [];
      }
      setFormData({
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-x-5 gap-y-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col space-y-1", children: [
              ...
              /* @__PURE__ */ jsx(
                DateOfBirthPicker,
                {
                  value: formData?.date_of_birth ? dayjs(
            ...
            /* @__PURE__ */ jsxs("div", { className: " col-span-2 space-y-1", children: [
              ...
              /* @__PURE__ */ jsx(
                Textarea,
                {
                  id: "bio",
                  name: "bio",
                  value: formData?.bio.charAt(0).toUpperCase() + formData?.bio.slice(1),
                  ref: inputRefs.bio,
                  onChange: handleChange,
                  className: "resize-none rounded-none h-20 bg-slate-100 focus:border-transparent focus:ring-0 focus:outline-none border-none"
                }
