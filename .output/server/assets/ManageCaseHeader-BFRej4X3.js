...
import { A as ApproveDialog, C as CompleteLogo } from "./complete-logo-DwVwh2_J.js";
...
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent, d as TooltipArrow } from "./tooltip-BKF0DBvK.js";
import { h as caseViewAddNoteAPI, i as caseViewNoteDeleteAPI, j as caseUpdateNoteAPI, c as caseViewNotesAPI, k as caseViewNoteAPI, C as CaseStageStatus } from "./manage-tW0NLyej.js";
import { c as getAllTodoCountsAPI } from "./notification-kzFgGftV.js";
...
import { a as uploadDocumentAPI } from "./fileUpload-BBm5-XTb.js";
...
const isSubStageCompleted = (subStages, subStageCode) => {
  ...
  return subStages?.find((sub) => sub.code === subStageCode)?.status === "completed";
};
...
const MultiPartUploadComponent = ({
  ...
  const uploadFileIntoChunks = async (uploadId, file, index, key, chunkSize, totalChunks, unuploadedParts, initialProgress) => {
    ...
    try {
      const existingEtags = unuploadedParts?.length ? etagsMap[index] || [] : [];
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(SheetContent, { className: "bg-white w-4/12 p-2 font-primary ", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-4 space-y-2 h-[calc(100vh-70px)] overflow-y-auto", children: [
            ...
            !isAddNotesOpen && !isEditNotesOpen && /* @__PURE__ */ jsx(Fragment, { children: isLoadingCaseNote ? (
            ...
            ) : allRecords.length > 0 ? allRecords.map((record, index) => /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
                  /* @__PURE__ */ jsx(Avatar, { className: "flex items-center justify-center h-8 w-8", children: record?.created_by?.profile_pic ? /* @__PURE__ */ jsx(
                    AvatarImage,
                    {
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: record?.updated_at === null ? formatDate(record?.created_at) : formatDate(record?.updated_at) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end", children: [
                  record?.created_by?.id === userType && /* @__PURE__ */ jsx(
                    Button,
                    {
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1 mt-3", children: [
                /* @__PURE__ */ jsx("div", { className: "text-sm 3xl:text-base text-black opacity-90  font-medium", children: record?.title }),
                /* @__PURE__ */ jsx("div", { className: "text-xs 3xl:text-sm text-[#444] list-none opacity-80 font-normal ", children: record?.note.split("\n").map((note, index2) => /* @__PURE__ */ jsxs(
                  "div",
                  {
            ...
            ] }, index)) : /* @__PURE__ */ jsx("div", { className: "text-center text-gray-500 text-sm h-full flex items-center justify-center", children: "No Case History available" }) })
          ] })
        ] })
      ]
    }
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-4 space-y-2 h-[calc(100vh-70px)] overflow-y-auto", children: [
            isAddNotesOpen && /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsx(
                ...
                {
                  placeholder: "Title",
                  value: subStage === "ONBD#ADEC" ? "Case Facts and Opinion" : subStage === "TRPH#JUDG" ? "Judgement & Further Process" : noteTitle?.charAt(0)?.toUpperCase() + noteTitle?.slice(1),
...
const ManageCaseHeader = ({
  ...
  const { mutateAsync: mutateCaseStageStatus, isPending: isUpdateCaseStage } = useMutation({
    ...
    onSuccess: async () => {
      ...
      if (updatedStages?.data?.stages?.every(
...
export {
  Drawer as D,
  ManageCaseHeader as M,
  fileSizeInMB as a,
  DrawerTrigger as b,
  DrawerContent as c,
  DrawerClose as d,
  formatDate as f,
  getSubStageTitle as g,
  isSubStageCompleted as i
};
