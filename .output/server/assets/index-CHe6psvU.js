...
import { T as TanStackTable, P as PaginationComponent } from "./TanstackTable-Be14m9-C.js";
import { S as SettingsIcon, g as getInitialView, T as TableViewIcon, G as GridViewIcon, E as EmptyCaseCard, C as CaseCard, v as viewStateHelper, V as VIEW_KEYS } from "./settings-icon-BOhtuulz.js";
import { B as Button } from "./router-o2MrkizZ.js";
import { a as getAllLegalOpinionAPI } from "./litigations-2Q1m8RsY.js";
import { D as DEFAULT_HEIGHT_CLASS } from "./advocate-DLfkmGnv.js";
import { u as userStore } from "./userDetails-Dbr9T6uw.js";
import { c as capitalize, a as addSerial } from "./app-CEOvaEAI.js";
...
import { S as SearchDropdown } from "./SearchDropdown-Be05Vh42.js";
...
function LegalOpinionColumns() {
  ...
  if (isUser() || isManager() || isAdmin()) {
    columns.splice(2, 0, {
      accessorFn: (row) => {
        const firstName = row.advocate?.first_name ? capitalize(row.advocate.first_name) : "";
        const lastName = row.advocate?.last_name ? capitalize(row.advocate.last_name) : "";
        return {
  ...
  if (isAdvocate() || isManager() || isAdmin() || isUser()) {
    columns.splice(2, 0, {
      accessorFn: (row) => {
        const name = isUser() ? row.customer_name ? capitalize(row.customer_name) : "" : `${row.user?.first_name ? capitalize(row.user.first_name) : ""} ${row.user?.last_name ? capitalize(row.user.last_name) : ""}`;
...
const LegalOpinion = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "overflow-hidden h-full relative", children: isClient && /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    tabsValue === "table" ? /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto", children: isLoading ? /* @__PURE__ */ jsx(EmptyCaseCard, {}) : lawyersData?.records && lawyersData?.records.length > 0 ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4  p-0", children: lawyersData?.records?.map((record) => /* @__PURE__ */ jsx(CaseCard, { record }, record.id)) }) : /* @__PURE__ */ jsx("div", { className: "flex justify-center items-center w-full h-120", children: /* @__PURE__ */ jsx(
        NoDataDisplay,
        {
      ...
      lawyersData?.records && lawyersData?.records.length > 0 && lawyersData?.pagination_info && /* @__PURE__ */ jsx("div", { className: "sticky bottom-0 bg-white", children: /* @__PURE__ */ jsx("div", { className: "flex justify-center items-center gap-4", children: /* @__PURE__ */ jsx(
        PaginationComponent,
        {
          paginationDetails: lawyersData?.pagination_info,
          capturePageNum,
