...
import { d as singleAdvocateAPI } from "./advocate-Cvw6EtWS.js";
import { a as addOrganizationAPI, u as updateOrganizationAPI } from "./organization-9L2vrBNN.js";
...
const CreateOrganization = () => {
  ...
  useEffect(() => {
    if (organizationData) {
      ...
      setStateSearch(
        stateOptions.find((s) => s.code === organizationData.state)?.name || organizationData.state || ""
      );
    }
  }, [organizationData]);
