...
import { Check, X, ChevronsUpDown, Loader2, Circle, Calendar, XIcon } from "lucide-react";
...
import { C as Command, a as CommandInput, b as CommandList, c as CommandEmpty, d as CommandGroup, e as CommandItem } from "./command-DoJaARCj.js";
import { C as Calendar$1 } from "./calendar-BN2MwFmY.js";
import { S as Separator } from "./separator-BzkEE94Y.js";
import dayjs from "dayjs";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, e as SelectGroup, d as SelectItem } from "./select-DGUsKCQS.js";
import { l as getAllLocations, o as orgsDropdown, O as OrgsStatsAPI, m as advOrgDropDown, n as advLocDropdown } from "./dashboard-uQmz2qHd.js";
...
function ComboBox({
  ...
  const selected = React.useMemo(() => {
    ...
    return items.find((it) => it.id === value.id) ?? null;
  }, [value, items]);
  ...
  return /* @__PURE__ */ jsxs(Popover, { open, onOpenChange: setOpen, children: [
    ...
    /* @__PURE__ */ jsx(PopoverContent, { className: `w-[260px] p-0 ${contentClassName ?? ""}`, children: /* @__PURE__ */ jsxs(Command, { shouldFilter: false, children: [
      /* @__PURE__ */ jsx(
        CommandInput,
        {
          placeholder: "Search...",
            ...
            /* @__PURE__ */ jsx(CommandGroup, { children: filtered.map((item) => {
              ...
              return /* @__PURE__ */ jsxs(
                CommandItem,
                {
                  ...
                  className: `flex justify-between items-center ${itemClassName ?? ""} ${isSelected ? "bg-accent" : ""}`,
                  children: [
...
function CustomSelectDropdown(props) {
  ...
  return /* @__PURE__ */ jsxs(Select, { value: value?.toString(), onValueChange: handleValueChange, children: [
    ...
    /* @__PURE__ */ jsx(SelectContent, { className: "bg-white border-gray-200 h-[40vh]", children: /* @__PURE__ */ jsx(SelectGroup, { children: options?.map((option) => /* @__PURE__ */ jsx(
      SelectItem,
      {
...
const transformApiData = (apiData) => {
  ...
  apiData.forEach((entry) => {
    ...
    entry.service_types?.forEach((service) => {
...
export {
  ...
  INRFormatter as I,
  useLocations as a,
  useOrganizationDropdown as b,
  CustomDateRangePicker as c,
  useAdvocateOrgDropdown as d,
  useAdvocateLocationDropdown as e,
  getIcon as g,
  useOrganizationsStats as u
};
