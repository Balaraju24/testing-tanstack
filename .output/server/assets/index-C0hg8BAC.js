...
import { h as downloadSingleDocAPI, e as documentApprovalAPI } from "./fileUpload-BBm5-XTb.js";
...
function FileCheckVerification({
        ...
        "tr",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-4 py-3 text-sm text-gray-900", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
              ...
              acceptedDocs.has(doc.id) || doc?.verification_status === "APPROVED" ? /* @__PURE__ */ jsx(
                "button",
                {
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-full relative", children: allDocsIsLoading ? /* @__PURE__ */ jsx(
    ...
    !Array.isArray(allDocsData) || allDocsData?.length === 0 ? /* @__PURE__ */ jsx("div", { className: "px-4 py-5 sm:px-6", children: /* @__PURE__ */ jsx("h3", { className: "text-lg font-normal leading-6 text-gray-900", children: "No Documents Uploaded" }) }) : /* @__PURE__ */ jsxs("div", { className: "w-full overflow-auto", children: [
      ...
      !isLoading && Array.isArray(allDocsData) && allDocsData?.[0]?.remarks && /* @__PURE__ */ jsxs("div", { className: "col-span-12 space-y-2 mt-4 flex flex-col p-4 pt-2", children: [
