...
import { a as getOrganizationDataAPI, c as createLegalOpinionAPI, b as createManagerLegalOpinionAPI } from "./legalOpinion-qNiAW4Gj.js";
import { l as loanTypeOptions, p as propertyOptions } from "./litigation-b6202F6J.js";
...
const CreateLegalOpinion = () => {
  ...
  const filteredOrganizations = organisationData?.filter((org) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col h-[calc(100vh-120px)] justify-center items-center bg-white", children: /* @__PURE__ */ jsx("div", { className: "flex justify-center items-center py-8", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-3xl px-4", children: [
    ...
    /* @__PURE__ */ jsxs("form", { className: "bg-white border border-gray-300 p-4 grid grid-cols-1 md:grid-cols-2 gap-6", children: [
      (isManager() || isAdmin()) && /* @__PURE__ */ jsxs("div", { children: [
        ...
        errors?.organisation_name && /* @__PURE__ */ jsx("p", { className: "text-xs 3xl:text-sm text-red-500 font-medium", children: errors?.organisation_name })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        errors?.customer_name && /* @__PURE__ */ jsx("p", { className: "text-xs 3xl:text-sm text-red-500 font-medium", children: errors?.customer_name })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
