...
import { c as getAllTodoCountsAPI, t as todoMarkAsReadAPI, d as getAllTodoAPI } from './notification-kzFgGftV.mjs';
import { l as labelStage, a as labelSubStages } from './statusConstants-t7T05Rlh.mjs';
...
const Todo = ({ case_id, iconType }) => {
  ...
  const allTodo = (TodoData == null ? void 0 : TodoData.pages.map((page) => page.data).flat()) || [];
  useEffect(() => {
  ...
  const handleTodoClick = (todo) => {
    var _a, _b;
    if (!(todo == null ? void 0 : todo.is_marked)) {
      markAsReadTodo(todo == null ? void 0 : todo.id);
    }
    const encodedStage = encodeURIComponent(todo == null ? void 0 : todo.case_stage);
    const encodedSubStage = encodeURIComponent(todo == null ? void 0 : todo.case_sub_stage);
    setIsTodoOpen(false);
    setActiveTab("todo");
    const base = isUser() ? "user/manage" : "manage";
    let serviceType = ((_b = (_a = todo == null ? void 0 : todo.case) == null ? void 0 : _a.service_type) == null ? void 0 : _b.toLowerCase().replace(/\s+/g, "-")) || "";
    if (serviceType === "litigation") {
      serviceType = "litigations";
    }
    navigate({
      to: `/${serviceType}/service/${todo == null ? void 0 : todo.case_id}/${base}?stage=${encodedStage}&sub_stage=${encodedSubStage}`
    });
  };
  return /* @__PURE__ */ jsxs(
    Sheet,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(SheetContent, { className: "w-3/12  font-primary gap-1 space-y-1  bg-white p-0 shadow-md rounded-md border border-gray-200", children: [
          ...
          ] }, index)) }) : (allTodo == null ? void 0 : allTodo.length) ? /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              return /* @__PURE__ */ jsx(
                "li",
                {
                  ...
                  children: /* @__PURE__ */ jsxs(
                    "div",
                    {
                      className: `py-3 px-2 flex gap-2 ${!(todo == null ? void 0 : todo.is_marked) && "bg-blue-100"} `,
                      children: [
                        !(todo == null ? void 0 : todo.is_marked) && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("div", { className: "h-1.5 w-1.5 mt-2 bg-sky-500 rounded-full" }) }),
                        /* @__PURE__ */ jsxs("div", { className: "space-y-2 grow", children: [
                          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                            /* @__PURE__ */ jsx("div", { className: "text-sm 3xl:md px-1  border border-gray-300 bg-gray-100", children: ((_a = todo == null ? void 0 : todo.case) == null ? void 0 : _a.cnr_number) || ((_b = todo == null ? void 0 : todo.case) == null ? void 0 : _b.cmp_number) || ((_c = todo == null ? void 0 : todo.case) == null ? void 0 : _c.ref_id) || ((_d = todo == null ? void 0 : todo.case) == null ? void 0 : _d.temp_id) || "--" }),
...
export { Todo as T };
//# sourceMappingURL=Todo-9fPLLx5K.mjs.map
