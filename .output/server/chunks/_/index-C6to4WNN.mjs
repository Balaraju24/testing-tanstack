...
import { d as updateDueDateAPI } from './legalOpinion-qNiAW4Gj.mjs';
...
const SetDueDate = ({
  ...
  const updateDueDateMutation = useMutation({
    ...
    onError: (response) => {
      ...
      if ((_a = response == null ? void 0 : response.data) == null ? void 0 : _a.errData) {
        errorMessage = (_b = response == null ? void 0 : response.data) == null ? void 0 : _b.errData.due_date[0];
      } else if ((_d = (_c = response == null ? void 0 : response.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) {
        errorMessage = response.response.data.message;
      } else if (response == null ? void 0 : response.message) {
  ...
  useEffect(() => {
    if (serviceData == null ? void 0 : serviceData.due_date) {
      const existingDate = serviceData.due_date;
      setSelectedDate(existingDate);
    }
    if ((serviceData == null ? void 0 : serviceData.due_date) === null) {
      setIsEditing(true);
    }
  }, [serviceData == null ? void 0 : serviceData.due_date]);
  return /* @__PURE__ */ jsx("div", { className: "h-full", children: isPrevSubStageCompleted ? /* @__PURE__ */ jsx("div", { className: "h-full px-1", children: /* @__PURE__ */ jsxs("div", { className: "h-full relative", children: [
    /* @__PURE__ */ jsx(
      ManageCaseHeader,
      {
        ...
        showActionButton: isUser() ? false : (serviceData == null ? void 0 : serviceData.due_date) !== null && !isEditing,
        showUploadButton: false,
        showNoteButton: false
      }
    ),
    isUser() ? /* @__PURE__ */ jsx("div", { className: "p-4", children: (serviceData == null ? void 0 : serviceData.due_date) ? /* @__PURE__ */ jsx("div", { className: "flex bg-slate-100 justify-between items-center gap-2 border p-2", children: /* @__PURE__ */ jsxs("p", { className: "text-sm", children: [
      "Due Date :",
      " ",
      dayjs(serviceData == null ? void 0 : serviceData.due_date).format("DD MMM YYYY")
      ...
      (serviceData == null ? void 0 : serviceData.due_date) === null ? /* @__PURE__ */ jsx(
        Button,
        {
...
export { SetDueDate as default };
//# sourceMappingURL=index-C6to4WNN.mjs.map
