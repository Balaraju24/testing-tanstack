...
const FeedbackCard = ({ review }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-2 bg-gray-100 space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
      ...
      /* @__PURE__ */ jsx(Rating, { rating: parseFloat(review == null ? void 0 : review.rating) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsx("h4", { className: "text-md leading-none font-medium", children: "Feedback" }),
      /* @__PURE__ */ jsx("div", { className: "text-sm", children: /* @__PURE__ */ jsx(UnOrderList, { text: review == null ? void 0 : review.feedback }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsx("h4", { className: "text-md leading-none font-medium", children: "Suggestions for Improvement" }),
      /* @__PURE__ */ jsx("div", { className: "text-sm", children: ((_a = review == null ? void 0 : review.suggestion) == null ? void 0 : _a.trim()) ? /* @__PURE__ */ jsx(UnOrderList, { text: review.suggestion }) : "--" })
    ] })
  ] });
};

export { FeedbackCard as F };
//# sourceMappingURL=FeedbackCard-Bc0eS10N.mjs.map
