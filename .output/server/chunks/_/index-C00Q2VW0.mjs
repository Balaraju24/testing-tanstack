...
import { a as getCasesCountAPI, b as getLocationStatsCountAPI, c as getServicesCountApi, d as getAdvocateServicesCountAPI, g as getOrgServiceCasesCount, e as getOrganizationsCountAPI, f as getAdvocatesCountAPI, h as getManagersCountAPI, i as getNextHearingDateAPI, j as getDueDateAPI, k as getOrganizationAnalytics } from './dashboard-uQmz2qHd.mjs';
...
import { I as INRFormatter, g as getIcon, c as useOrganizationsStats, u as useLocations, a as useOrganizationDropdown, d as useAdvocateOrgDropdown, e as useAdvocateLocationDropdown, C as ComboBox, b as CustomDateRangePicker } from './dashboard_queries-Cldy_CAd.mjs';
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent } from './tooltip-BKF0DBvK.mjs';
import { useNavigate } from '@tanstack/react-router';
import { M as ManagerIcon, A as AdvocateIcon } from './ManagerIcon-_z3rIyGq.mjs';
...
const HearingCard = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `h-full ${bg} p-2`, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "h-[calc(100%-40px)]  p-2 space-y-2", children: isLoading ? /* @__PURE__ */ jsx("div", { className: "flex justify-center items-center h-full", children: /* @__PURE__ */ jsx(Loader2, { className: "animate-spin w-6 h-6 text-gray-500" }) }) : (data == null ? void 0 : data.length) === 0 ? /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center h-full", children: emptyState }) : /* @__PURE__ */ jsxs("div", { className: "h-full space-y-1.5 overflow-auto ", children: [
      data == null ? void 0 : data.map((item, index) => {
        var _a, _b;
        const dateVal = (item == null ? void 0 : item[dateField]) ? new Date(item == null ? void 0 : item[dateField]) : null;
        ...
        const userName = (item == null ? void 0 : item.user) ? `${(item == null ? void 0 : item.user.first_name) || ""} ${(item == null ? void 0 : item.user.last_name) || ""}`.trim() : "--";
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            onClick: () => {
              if (handleRoute) {
                handleRoute(item == null ? void 0 : item.id);
              }
            },
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center min-w-[60px]", children: [
                showOverdue && (item == null ? void 0 : item.status) === "OVERDUE" && /* @__PURE__ */ jsx("div", { className: "bg-red-500 w-full text-center text-xs text-white", children: "Overdue" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between flex-1 p-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "space-y-1  flex flex-col justify-between", children: [
                  /* @__PURE__ */ jsx("div", { className: "text-xs", children: (item == null ? void 0 : item.organisation_name) || "--" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "space-y-1  flex flex-col items-center", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "flex items-center", children: ((_a = item == null ? void 0 : item.advocate_cases) == null ? void 0 : _a.length) > 0 ? /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [
                    /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxs("div", { className: "flex -space-x-2", children: [
                      item.advocate_cases.slice(0, 2).map((advocate, idx) => {
                        const firstName = (advocate == null ? void 0 : advocate.advocate.first_name) || "";
                        const lastName = (advocate == null ? void 0 : advocate.advocate.last_name) || "";
                          ...
                          Avatar,
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsx(
                                AvatarImage,
                                {
                                  src: advocate == null ? void 0 : advocate.advocate.profile_pic,
                                  alt: firstName
                                }
                              ),
                            ...
                            children: [
                              /* @__PURE__ */ jsxs(Avatar, { className: "size-5 border", children: [
                                /* @__PURE__ */ jsx(
                                  AvatarImage,
                                  {
                                    src: adv == null ? void 0 : adv.advocate.profile_pic
                                  }
                                ),
                                /* @__PURE__ */ jsx(AvatarFallback, { className: "bg-gray-100 text-xs", children: (((_a2 = adv == null ? void 0 : adv.advocate.first_name) == null ? void 0 : _a2[0]) || "") + (((_b2 = adv == null ? void 0 : adv.advocate.last_name) == null ? void 0 : _b2[0]) || "") })
                              ] }),
                              /* @__PURE__ */ jsx("span", { children: `${(adv == null ? void 0 : adv.advocate.first_name) || ""} ${(adv == null ? void 0 : adv.advocate.last_name) || ""}` })
                            ]
                          },
                          i
                        );
                  ...
                  /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-400 font-light", children: ((_b = item == null ? void 0 : item.advocate_cases) == null ? void 0 : _b.length) == 0 ? "No Advocate" : "Advocate" })
                ] })
              ] })
            ]
          },
...
const CalendarHearingsSection = () => {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      try {
        ...
        if (selectedDate) {
          queryParams = {
            from_date: dayjs(selectedDate == null ? void 0 : selectedDate.from).format("YYYY-MM-DD"),
            to_date: dayjs(selectedDate == null ? void 0 : selectedDate.to).format("YYYY-MM-DD")
          };
        }
        const response = await getNextHearingDateAPI(queryParams);
        if (response.status == 200 || response.status == 201) {
          const data = (_b = (_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.data) == null ? void 0 : _b.records;
          return data;
        } else {
  ...
  const {
    ...
    queryFn: async ({ pageParam = 1 }) => {
      ...
      try {
        let queryParams = {};
        if (dueDateRange) {
          queryParams.from_date = dayjs(dueDateRange == null ? void 0 : dueDateRange.from).format(
            "YYYY-MM-DD"
          );
          queryParams.to_date = dayjs(dueDateRange == null ? void 0 : dueDateRange.to).format("YYYY-MM-DD");
        }
    ...
    getNextPageParam: (lastPage) => {
      var _a2, _b;
      const currentPage = (_a2 = lastPage == null ? void 0 : lastPage.pagination_info) == null ? void 0 : _a2.current_page;
      const totalPages = (_b = lastPage == null ? void 0 : lastPage.pagination_info) == null ? void 0 : _b.total_pages;
      return currentPage && currentPage < totalPages ? currentPage + 1 : null;
    }
  });
  const allDueDateData = ((_a = dueDateData == null ? void 0 : dueDateData.pages) == null ? void 0 : _a.flatMap((page) => page == null ? void 0 : page.records)) || [];
  useMemo(() => {
    let hearingsToProcess = [];
    if (Array.isArray(hearingData)) {
      hearingsToProcess = hearingData;
    } else if (hearingData == null ? void 0 : hearingData.records) {
  ...
  const currentHearings = useMemo(() => {
    ...
    if (!(hearingData == null ? void 0 : hearingData.records)) return [];
...
const OrganizationStatistics = () => {
  ...
  const allLocations = (_a = locationData == null ? void 0 : locationData.records) == null ? void 0 : _a.map((location2) => {
    return {
      id: location2.id,
  ...
  const allAdvocatesOrg = advocatesOrgData == null ? void 0 : advocatesOrgData.map((advocate) => {
    return {
      id: advocate.id,
  ...
  const allAdvocatesLoc = advocatesLocData == null ? void 0 : advocatesLocData.map((advLoc) => {
    return {
      id: advLoc.id,
      label: advLoc.name
    };
  ...
  useEffect(() => {
    if (!(dateRange == null ? void 0 : dateRange.from) || !(dateRange == null ? void 0 : dateRange.to) || !isAdmin()) return;
  ...
  if ((organizations == null ? void 0 : organizations.length) === 0)
    return /* @__PURE__ */ jsxs("div", { className: "mt-2 p-4 bg-white", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "relative", children: isAdvocate() ? /* @__PURE__ */ jsx(
            ComboBox,
            {
              ...
              value: allAdvocatesOrg == null ? void 0 : allAdvocatesOrg.find(
          ...
          isAdvocate() && /* @__PURE__ */ jsx(
            ComboBox,
            {
              ...
              value: allAdvocatesLoc == null ? void 0 : allAdvocatesLoc.find((l) => l.id === location),
              onChange: (item) => setLocation(item == null ? void 0 : item.id),
              defaultIcon: MapPin,
              className: "h-8 text-smd font-light border-gray-300",
              contentClassName: "bg-white rounded",
              isLoading,
          ...
          isAdmin() && /* @__PURE__ */ jsx(
            ComboBox,
            {
              items: allLocations,
              placeholder: "Select Location",
              value: allLocations == null ? void 0 : allLocations.find((l) => l.id === location),
              onChange: (item) => setLocation(item == null ? void 0 : item.id),
              defaultIcon: MapPin,
              className: "h-8 text-smd font-light border-gray-300",
              contentClassName: "bg-white rounded",
  ...
  const columns = useMemo(() => {
    ...
    return [
      ...
      ...serviceTypes.map((type) => ({
        ...
        accessorFn: (row) => {
          var _a, _b;
          return (_b = (_a = row.service_types.find((s) => s.service_type === type)) == null ? void 0 : _a.cases_count) != null ? _b : 0;
        },
        size: baseSize,
        minSize: 80,
        maxSize: 150
...
const StatisticsSection = () => {
  ...
  const { data: advocateServiceCount } = useQuery({
    ...
    queryFn: async () => {
      var _a2;
      const response = await getAdvocateServicesCountAPI(userDetails == null ? void 0 : userDetails.id);
      return (_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.data;
    },
    enabled: isAdvocate(),
    refetchOnWindowFocus: false,
  ...
  const stats1 = [
    {
      name: "Locations",
      icon: MapPin,
      count: (locationsCount == null ? void 0 : locationsCount.count) || 0,
    ...
    },
    {
      name: "Managers",
      icon: ManagerIcon,
      count: (managersCount == null ? void 0 : managersCount.count) || 0,
    ...
    },
    {
      ...
      count: (organizationsCount == null ? void 0 : organizationsCount.count) || 0,
    ...
    },
    {
      name: "Advocates",
      icon: AdvocateIcon,
      count: (advocatesCount == null ? void 0 : advocatesCount.count) || 0,
    ...
    },
    {
      name: "Total Cases",
      icon: TotalCasesIcon,
      count: (dashboardStats == null ? void 0 : dashboardStats.count) || 0,
      color: "bg-amber-100 text-amber-500",
      userType: ["ADMIN", "MANAGER", "ADVOCATE"]
    }
  ];
  const legalOpinionCount = isAdvocate() ? (_a = advocateServiceCount == null ? void 0 : advocateServiceCount.find((s) => s.service_type === "Legal opinion")) == null ? void 0 : _a.cases_count : (_b = servicesCount == null ? void 0 : servicesCount.find((s) => s.service_type === "Legal opinion")) == null ? void 0 : _b.cases_count;
  const litigationCount = isAdvocate() ? (_c = advocateServiceCount == null ? void 0 : advocateServiceCount.find((s) => s.service_type === "Litigation")) == null ? void 0 : _c.cases_count : (_d = servicesCount == null ? void 0 : servicesCount.find((s) => s.service_type === "Litigation")) == null ? void 0 : _d.cases_count;
  const eopCount = isAdvocate() ? (_e = advocateServiceCount == null ? void 0 : advocateServiceCount.find(
    (s) => s.service_type === "Engineer property valuation"
  )) == null ? void 0 : _e.cases_count : (_f = servicesCount == null ? void 0 : servicesCount.find(
    (s) => s.service_type === "Engineer property valuation"
  )) == null ? void 0 : _f.cases_count;
  ...
  const stats2 = [
    {
      ...
      revenue: (_g = servicesCount == null ? void 0 : servicesCount.find(
        (s) => s.service_type === "Legal opinion"
      )) == null ? void 0 : _g.revenue,
      color: "bg-green-100 text-green-600",
      icon: LegalCasesIcon,
    ...
    },
    {
      ...
      cases: eopCount,
      revenue: servicesCount == null ? void 0 : servicesCount.find(
        (s) => s.service_type === "Engineer property valuation"
      ),
      color: "bg-blue-100 text-blue-600",
    ...
    },
    {
      ...
      revenue: (_h = servicesCount == null ? void 0 : servicesCount.find((s) => s.service_type === "Litigation")) == null ? void 0 : _h.revenue,
      color: "bg-violet-100 text-violet-600",
      icon: Litigation,
  ...
  const customerStats = allServices.map((service) => {
    const serviceData = orgCasesCount == null ? void 0 : orgCasesCount.find(
    ...
    (isAdmin() || isManager()) && /* @__PURE__ */ jsxs("div", { className: "", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-2 grid grid-cols-3 gap-2", children: stats2.map((stat, index) => /* @__PURE__ */ jsxs(
        "div",
        {
          onClick: () => {
            var _a2;
            return handleRoute((_a2 = stat.path) != null ? _a2 : "");
          },
    ...
    isUser() && /* @__PURE__ */ jsx("div", { className: "space-y-2", children: customerStats.map((item, index) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-2 my-1", children: statusConfig == null ? void 0 : statusConfig.map((status) => /* @__PURE__ */ jsxs(
            "div",
            {
...
//# sourceMappingURL=index-C00Q2VW0.mjs.map
