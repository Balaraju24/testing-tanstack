...
import { g as getOrganizationListAPI } from './legalOpinion-qNiAW4Gj.mjs';
import { c as getLitigationAPI, d as createManagerLitigationAPI, e as createLitigationAPI } from './litigations-2Q1m8RsY.mjs';
import { u as useUserDetails } from './useUserPermissions-IrViIWLA.mjs';
import { useQuery, useInfiniteQuery, useMutation } from '@tanstack/react-query';
import { useNavigate } from '@tanstack/react-router';
import { useState, useEffect } from 'react';
import { toast } from 'sonner';
import { i as issueIcons, g as getIssueIcon } from './litigation-b6202F6J.mjs';
import { ArrowLeftIcon, Loader2, Search, X } from 'lucide-react';
...
const useLitigationLogic = () => {
  ...
  const {
    ...
    queryFn: async ({ pageParam }) => {
      ...
      if ((response == null ? void 0 : response.status) === 200 || (response == null ? void 0 : response.status) === 201) {
        const paginationInfo = (_b = (_a = response == null ? void 0 : response.data) == null ? void 0 : _a.data) == null ? void 0 : _b.pagination_info;
        return {
          data: ((_d = (_c = response == null ? void 0 : response.data) == null ? void 0 : _c.data) == null ? void 0 : _d.records) || [],
          currentPage: (paginationInfo == null ? void 0 : paginationInfo.current_page) || pageParam,
          hasMore: (paginationInfo == null ? void 0 : paginationInfo.next_page) !== null,
          totalPages: (paginationInfo == null ? void 0 : paginationInfo.total_pages) || 1,
          nextPage: paginationInfo == null ? void 0 : paginationInfo.next_page
        };
      }
      return {
        data: [],
  ...
  const getOrganizations = () => {
    if (!(organisationData == null ? void 0 : organisationData.pages)) return [];
  ...
  const getCurrentStep = () => {
    switch (currentStep) {
      ...
      case "subIssue":
        return 3;
      case "organization":
        return (selectedService == null ? void 0 : selectedService.issue) === "Notices" ? 4 : 2;
      default:
        return 1;
    }
  };
  const getTotalSteps = () => {
    if ((selectedService == null ? void 0 : selectedService.issue) === "Notices") {
  ...
  const handleBackClick = () => {
    switch (currentStep) {
      ...
      case "subIssue":
        ...
        break;
      case "organization":
        if ((selectedService == null ? void 0 : selectedService.issue) === "Notices" && selectedIssueType) {
          setCurrentStep("subIssue");
          setSearchTerm("");
        } else {
          setCurrentStep("issue");
  ...
  const handleSubmit = () => {
    ...
    if ((selectedService == null ? void 0 : selectedService.issue) === "Notices" && selectedSubIssue) {
...
const IssueGrid = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-2 gap-4", children: issues.map((litigation, index) => {
    var _a, _b, _c;
    const isSelected = (selectedIssue == null ? void 0 : selectedIssue.id) === litigation.id;
    const icon = (_c = (_b = (_a = issueIcons)[litigation.issue]) == null ? void 0 : _b.call(_a, {
      className: `h-7 w-7 ${isSelected ? "text-white" : "text-black"}`
    })) != null ? _c : /* @__PURE__ */ jsx("span", { role: "img", "aria-label": "icon", className: "text-xl", children: "\u{1F4C4}" });
    return /* @__PURE__ */ jsx(
      "div",
      {
...
const IssueTypeGrid = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: issueTypes.map((issueType, index) => {
    ...
    ) : /* @__PURE__ */ jsx("span", { role: "img", "aria-label": "icon", className: "text-xl", children: "\u{1F4CB}" });
    return /* @__PURE__ */ jsx(
      "div",
      {
...
const OrganizationGrid = ({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3 mb-8", children: organizations.map((org, index) => {
      const isSelected = (selectedOrganization == null ? void 0 : selectedOrganization.id) === org.id;
      return /* @__PURE__ */ jsx(
        "div",
        {
...
const SubIssueGrid = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: subIssues.map((subIssue, index) => {
    const isSelected = (selectedSubIssue == null ? void 0 : selectedSubIssue.id) === subIssue.id;
    ...
    ) : /* @__PURE__ */ jsx("span", { role: "img", "aria-label": "icon", className: "text-xl", children: "\u{1F4D1}" });
    return /* @__PURE__ */ jsx(
      "div",
      {
...
//# sourceMappingURL=index-CjwtbvZ3.mjs.map
