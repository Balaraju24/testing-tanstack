...
import { h as caseViewAddNoteAPI, i as caseViewNoteDeleteAPI, j as caseUpdateNoteAPI, c as caseViewNotesAPI } from './manage-tW0NLyej.mjs';
import { n as notesViewAPI } from './service-1g9dZr4o.mjs';
...
const ServiceNotes = () => {
  ...
  const fetchCaseNotes = async ({ pageParam = 1 }) => {
    ...
    try {
      ...
      return {
        ...
        nextCursor: ((_e = (_d2 = (_c2 = response == null ? void 0 : response.data) == null ? void 0 : _c2.data) == null ? void 0 : _d2.pagination_info) == null ? void 0 : _e.next_page) ? ((_h = (_g = (_f = response == null ? void 0 : response.data) == null ? void 0 : _f.data) == null ? void 0 : _g.pagination_info) == null ? void 0 : _h.current_page) + 1 : null,
  ...
  const { mutate: mutateAddNote, isPending } = useMutation({
    ...
    onError: (error) => {
      ...
      if ((error == null ? void 0 : error.status) == 422) {
        setTitleError((_c2 = (_b2 = (_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.errData) == null ? void 0 : _b2.title) == null ? void 0 : _c2[0]);
        setNoteError((_f = (_e = (_d2 = error == null ? void 0 : error.data) == null ? void 0 : _d2.errData) == null ? void 0 : _e.note) == null ? void 0 : _f[0]);
      }
      toast.error(
  ...
  const { mutate: mutateDeleteNote, isPending: isLoadingDeleteNote } = useMutation({
    ...
    onError: (error) => {
      var _a2, _b2, _c2;
      if ((error == null ? void 0 : error.status) == 422) {
        setNoteError((_c2 = (_b2 = (_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.errData) == null ? void 0 : _b2.note) == null ? void 0 : _c2[0]);
      }
    }
  });
  const { mutate: mutateUpdateNote, isPending: isLoadingUpdateNote } = useMutation({
    ...
    onError: (error) => {
      ...
      if ((error == null ? void 0 : error.status) == 422) {
        setNoteError((_c2 = (_b2 = (_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.errData) == null ? void 0 : _b2.note) == null ? void 0 : _c2[0]);
        setTitleError((_f = (_e = (_d2 = error == null ? void 0 : error.data) == null ? void 0 : _d2.errData) == null ? void 0 : _e.title) == null ? void 0 : _f[0]);
      }
      toast.error(
        ((_g = error == null ? void 0 : error.data) == null ? void 0 : _g.message) || (error == null ? void 0 : error.message) || ((_i = (_h = error == null ? void 0 : error.data) == null ? void 0 : _h.data) == null ? void 0 : _i.error),
        {
  ...
  const handleViewClick = (noteId, noteType) => {
    ...
    const isRecordUnread = allRecords == null ? void 0 : allRecords.some(
      (record) => {
        var _a2;
        return record.id === noteId && ((_a2 = record == null ? void 0 : record.notes_read_status) == null ? void 0 : _a2.some(
  ...
  const renderTableRows = allRecords.map((record, index) => {
    ...
    const fullUsername = `${(_b2 = record == null ? void 0 : record.created_by) == null ? void 0 : _b2.first_name} ${(_c2 = record == null ? void 0 : record.created_by) == null ? void 0 : _c2.last_name}`;
        ...
        children: [
          /* @__PURE__ */ jsxs(TableCell, { className: "px-4 py-1 border-r border-gray-200 relative", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx(Avatar, { className: "w-8 h-8 flex items-center justify-center", children: ((_d2 = record == null ? void 0 : record.created_by) == null ? void 0 : _d2.profile_pic) ? /* @__PURE__ */ jsx(AvatarImage, { src: (_e = record.created_by) == null ? void 0 : _e.profile_pic }) : /* @__PURE__ */ jsx(DefaultUserIcon, { className: "w-4 2xl:w-5 2xl:h-5 h-4" }) }),
                ...
                selectedNoteId && !isEditMode && /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                    /* @__PURE__ */ jsxs("h2", { className: "text-sm font-normal capitalize", children: [
                      (_a = selectedNote == null ? void 0 : selectedNote.created_by) == null ? void 0 : _a.first_name,
                      " ",
                      (_b = selectedNote == null ? void 0 : selectedNote.created_by) == null ? void 0 : _b.last_name
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                      userType === ((_c = selectedNote == null ? void 0 : selectedNote.created_by) == null ? void 0 : _c.id) && (selectedNote == null ? void 0 : selectedNote.type) === "NOTE" && /* @__PURE__ */ jsx(
                        Button,
                        {
                      ...
                      userType === ((_d = selectedNote == null ? void 0 : selectedNote.created_by) == null ? void 0 : _d.id) && (selectedNote == null ? void 0 : selectedNote.type) === "NOTE" && /* @__PURE__ */ jsx(
                        Button,
                        {
                          className: "bg-transparent px-2 h-fit py-1 cursor-pointer",
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "mt-2", children: [
                    /* @__PURE__ */ jsx("h2", { className: "text-base font-normal mb-2", children: selectedNote == null ? void 0 : selectedNote.title }),
                    /* @__PURE__ */ jsx("p", { className: "text-gray-700 whitespace-pre-wrap", children: selectedNote == null ? void 0 : selectedNote.note.split("\n").map((note, index) => /* @__PURE__ */ jsx(
                      "div",
                      {
...
export { ServiceNotes as S };
//# sourceMappingURL=ServiceNotes-CIm2hWGi.mjs.map
