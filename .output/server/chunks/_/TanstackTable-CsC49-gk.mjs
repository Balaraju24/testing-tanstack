...
import { c as cn, b as buttonVariants } from './router-e7zdrxGz.mjs';
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from './select-DGUsKCQS.mjs';
...
const PaginationComponent = ({
  ...
  const totalPages = (_a = paginationDetails == null ? void 0 : paginationDetails.total_pages) != null ? _a : 1;
  const selectedValue = (_b = paginationDetails == null ? void 0 : paginationDetails.page_size) != null ? _b : 15;
  const totalRecords = (_c = paginationDetails == null ? void 0 : paginationDetails.total_records) != null ? _c : 0;
  const currentPage = (_d = paginationDetails == null ? void 0 : paginationDetails.current_page) != null ? _d : initialPage;
  ...
  return /* @__PURE__ */ jsxs(Pagination, { className: "flex justify-between items-center !mx-0 !px-0 sticky bottom-0 shadow-inner-none !shadow-none !bordeer-none", children: [
    /* @__PURE__ */ jsxs(PaginationContent, { className: "!px-0 pt-1 flex gap-5", children: [
      /* @__PURE__ */ jsxs(
        Select,
        {
          value: selectedValue == null ? void 0 : selectedValue.toString(),
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(SelectContent, { className: "w-[120px]  text-xs bg-white pointer", children: limitOptions.map((item) => {
              var _a2;
              return /* @__PURE__ */ jsx(
                SelectItem,
                {
                  value: (_a2 = item.value) == null ? void 0 : _a2.toString(),
...
const TanStackTable = ({
  ...
  const searchParams = new URLSearchParams(location == null ? void 0 : location.search);
  const [sorting, setSorting] = useState([]);
  const shouldStickyLastColumn = columns.length > 6;
  const lastColumnIndex = columns.length - 1;
  const table = useReactTable({
    columns,
    data: (data == null ? void 0 : data.length) ? data : [],
    state: { sorting },
  ...
  const sortAndGetData = useCallback(
    (header) => {
      ...
      if ((_a = searchParams.get("order_by")) == null ? void 0 : _a.startsWith(header.id)) {
      ...
      getData({
        ...searchParams,
        page: 1,
        page_size: searchParams.get("page_size") || (paginationDetails == null ? void 0 : paginationDetails.page_size) || 15,
        order_by: orderBy
      });
    },
    [
      ...
      searchParams,
      removeSortingForColumnIds,
      paginationDetails == null ? void 0 : paginationDetails.page_size
    ]
  );
  const getWidth = useCallback(
    (id) => {
      const widthObj = columns.find((col) => col.id === id);
      return widthObj ? (widthObj == null ? void 0 : widthObj.width) || (widthObj == null ? void 0 : widthObj.size) || "100px" : "100px";
    },
    [columns]
  );
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full rounded-md bg-white", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: loading ? /* @__PURE__ */ jsx("div", { className: "w-full h-full flex flex-col", children: /* @__PURE__ */ jsxs("table", { className: "w-full border-collapse bg-white min-w-full table-fixed", children: [
          /* @__PURE__ */ jsx("thead", { className: "bg-black border-b", children: table == null ? void 0 : table.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ jsx("tr", { className: "border-b", children: headerGroup.headers.map(
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200", children: [...Array((paginationDetails == null ? void 0 : paginationDetails.page_size) || 15)].map((_, i) => /* @__PURE__ */ jsx(
            "tr",
            {
          ...
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-200", children: (data == null ? void 0 : data.length) ? table == null ? void 0 : table.getRowModel().rows.map((row, index) => /* @__PURE__ */ jsx(
            "tr",
            {
              ...
              ...(row == null ? void 0 : row.original.issue_id) && (row == null ? void 0 : row.original.id) ? {
    ...
    !loading && (data == null ? void 0 : data.length) && paginationDetails ? /* @__PURE__ */ jsx("div", { className: " border-gray-200", children: /* @__PURE__ */ jsx(
      PaginationComponent,
      {
        paginationDetails,
        capturePageNum,
        captureRowPerItems,
        initialPage: (paginationDetails == null ? void 0 : paginationDetails.current_page) || 1
      }
    ) }) : null
  ] });
};
const SortItems = ({
  ...
  const location = useLocation();
  const searchParams = new URLSearchParams(location == null ? void 0 : location.search);
  const sortBy = (_a = searchParams.get("order_by")) == null ? void 0 : _a.split(":")[0];
  const sortDirection = (_b = searchParams.get("order_by")) == null ? void 0 : _b.split(":")[1];
  if (removeSortingForColumnIds == null ? void 0 : removeSortingForColumnIds.includes(header.id)) {
    return null;
  }
...
export { PaginationComponent as P, TanStackTable as T };
//# sourceMappingURL=TanstackTable-CsC49-gk.mjs.map
