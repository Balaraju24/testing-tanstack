...
import { A as AdvocateIcon, M as ManagerIcon } from './ManagerIcon-_z3rIyGq.mjs';
import { E as EngineerValuationIcon } from './engineer-property-valuation-icon-DvwJZRaE.mjs';
...
import { S as Sheet, a as SheetTrigger, b as SheetContent, c as SheetHeader, d as SheetTitle, e as SheetClose, f as SheetDescription } from './sheet-vrO17VYZ.mjs';
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent } from './tooltip-BKF0DBvK.mjs';
import { useLocation, Outlet, useNavigate, Link } from '@tanstack/react-router';
import { C as CaseStagesProvider } from './Provider-DRuE0d-A.mjs';
...
import { Bell, ChevronDown, LogOutIcon } from 'lucide-react';
...
import { g as getAllNotificationsCountsAPI, m as markAsReadAllAPI, a as markAsReadAPI, b as getAllNotificationsAPI } from './notification-kzFgGftV.mjs';
...
import { r as routesWithCustomBg } from './noDataConstants-CAKRQRCT.mjs';
...
function AppSidebar({ ...props }) {
  ...
  useEffect(() => {
    var _a;
    setUserType((_a = userDetails == null ? void 0 : userDetails.user_type) != null ? _a : null);
  }, []);
  const filteredNavMain = items.navMain.filter(
    (item) => {
      var _a;
      return (_a = item.userTypes) == null ? void 0 : _a.includes(userType);
    }
  );
...
const DropDownMenu = () => {
  ...
  const displayName = isClient ? (_a = `${(userDetails == null ? void 0 : userDetails.first_name) || ""} ${(userDetails == null ? void 0 : userDetails.last_name) || ""}`) == null ? void 0 : _a.trim() : "";
  const getUserTypeDisplay = (userType) => {
    var _a2, _b2;
    if (!userType) return "";
    if ((userType == null ? void 0 : userType.toLowerCase()) === "customer") {
      return "Point of Contact";
    }
    return ((_a2 = userType == null ? void 0 : userType.charAt(0)) == null ? void 0 : _a2.toUpperCase()) + ((_b2 = userType == null ? void 0 : userType.slice(1)) == null ? void 0 : _b2.toLowerCase());
  };
  const handleLogOut = () => {
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 cursor-pointer  bg-white pr-2 rounded-full", children: [
      /* @__PURE__ */ jsx(Avatar, { className: "h-9 w-9 rounded-full bg-[#F7F7F7] border border-gray-300 flex items-center justify-center", children: (userDetails == null ? void 0 : userDetails.avatar) ? /* @__PURE__ */ jsx(AvatarImage, { src: isClient ? userDetails == null ? void 0 : userDetails.avatar : "" }) : /* @__PURE__ */ jsx(DefaultUserIcon, { className: "w-4 h-4" }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "text-[11px]", children: getUserTypeDisplay(userDetails == null ? void 0 : userDetails.user_type) })
      ] }),
        ...
        children: [
          /* @__PURE__ */ jsx(DropdownMenuLabel, { className: "p-0 font-normal", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 px-1 py-1.5 text-left text-sm", children: [
            /* @__PURE__ */ jsxs(Avatar, { className: "h-8 w-8 rounded-full bg-[#e7e7e7] flex justify-center items-center", children: [
              /* @__PURE__ */ jsx(AvatarImage, { src: userDetails == null ? void 0 : userDetails.avatar, alt: "admin" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start text-left text-sm leading-tight", children: [
              ...
              /* @__PURE__ */ jsxs(Tooltip, { children: [
                /* @__PURE__ */ jsx(TooltipTrigger, { children: /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `truncate text-xs ${((_b = userDetails == null ? void 0 : userDetails.email) == null ? void 0 : _b.length) > 15 ? "tooltip-active" : ""}`,
                    children: (userDetails == null ? void 0 : userDetails.email) || "--"
                  }
                ) }),
                ((_c = userDetails == null ? void 0 : userDetails.email) == null ? void 0 : _c.length) > 15 && /* @__PURE__ */ jsx(TooltipContent, { className: "bg-white", children: userDetails == null ? void 0 : userDetails.email })
              ] })
            ] })
          ] }) }),
...
const GeneralNotifications = () => {
  ...
  const allNotifications = (notificationsData == null ? void 0 : notificationsData.pages.map((page) => page.data).flat()) || [];
  const { mutate: notificationReadAll, isPending: isReadAllNotifiPending } = useMutation({
    mutationFn: async () => await markAsReadAllAPI(),
    onSuccess: (response) => {
      var _a;
      toast.success((_a = response == null ? void 0 : response.data) == null ? void 0 : _a.message, {
        action: {
          label: "\u2715",
  ...
  const handleNotificationClick = (notification) => {
    ...
    if (message == null ? void 0 : message.includes("NOTE")) {
      path = `${basePath}/notes`;
    } else if (case_stage === "chat" && case_sub_stage === "case-chat") {
      path = `${basePath}/chat`;
    } else if ((message == null ? void 0 : message.includes("SUMMARY")) || (message == null ? void 0 : message.includes("next hearing date"))) {
    ...
    /* @__PURE__ */ jsxs(SheetContent, { className: "w-2/6 max-w-md  bottom-0 bg-white p-0 font-primary shadow-md rounded-md space-y-1 border border-gray-200", children: [
      /* @__PURE__ */ jsxs(SheetHeader, { className: "flex flex-row justify-between px-2 !pt-3  !pb-0 items-center space-y-0", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-1 items-center", children: [
          (allNotifications == null ? void 0 : allNotifications.length) > 0 && notificationCounts > 0 && /* @__PURE__ */ jsx(
            Button,
            {
      ...
      ] }, index)) }) : (allNotifications == null ? void 0 : allNotifications.length) ? /* @__PURE__ */ jsxs("div", { className: "h-full", children: [
            ...
            return /* @__PURE__ */ jsx(
              "li",
              {
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                  !(notification == null ? void 0 : notification.is_marked) && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("div", { className: "h-1.5 w-1.5 mt-2 bg-sky-500 rounded-full" }) }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2 grow", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsx("div", { className: "text-sm px-1  border border-gray-300 bg-gray-100", children: ((_a = notification == null ? void 0 : notification.case) == null ? void 0 : _a.cnr_number) || ((_b = notification == null ? void 0 : notification.case) == null ? void 0 : _b.cmp_number) || ((_c = notification == null ? void 0 : notification.case) == null ? void 0 : _c.ref_id) || ((_d = notification == null ? void 0 : notification.case) == null ? void 0 : _d.temp_id) || "--" }),
...
//# sourceMappingURL=_app-DT-60T8h.mjs.map
