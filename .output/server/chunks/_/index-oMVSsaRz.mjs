...
import { b as addSubStage, e as editSubStage, d as deleteSubStage, r as reorderSubStage } from './manage-tW0NLyej.mjs';
import { l as labelStage } from './statusConstants-t7T05Rlh.mjs';
...
function AddSubStageComponent() {
  ...
  const {
    ...
    queryKey: ["caseStages", search == null ? void 0 : search.case_id],
    queryFn: async () => {
      var _a2;
      const payload = {
        case_id: search == null ? void 0 : search.case_id
      };
    ...
    enabled: !!(search == null ? void 0 : search.case_id),
    refetchOnWindowFocus: false
  });
  useEffect(() => {
    if (caseStagesData == null ? void 0 : caseStagesData.sub_stages) {
      const filteredSubStages = getSubStagesForStage(
        caseStagesData.sub_stages,
        search == null ? void 0 : search.stage
      );
  ...
  }, [caseStagesData, search == null ? void 0 : search.stage]);
  const { mutate: mutateAddSubStage, isPending: AddingSubStage } = useMutation({
    mutationFn: async (payload) => {
      const response = await addSubStage(Number(search == null ? void 0 : search.case_id), payload);
      return response;
    },
    onSuccess: (response) => {
      var _a2;
      toast.success((_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.message, {
        action: {
          label: "\u2715",
    ...
    onError: (error) => {
      var _a2, _b;
      const errorMessage = ((_b = (_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.errData) == null ? void 0 : _b.sub_stage_title[0]) || (error == null ? void 0 : error.message);
      setSubStageError(errorMessage);
    }
  });
  const { mutate: mutateEditSubStage, isPending: EditSubstage } = useMutation({
    mutationFn: async (payload) => {
      const response = await editSubStage(Number(search == null ? void 0 : search.case_id), payload);
      return response;
    },
    onSuccess: (response) => {
      var _a2;
  ...
  const { mutate: mutateDeleteSubStage, isPending: DeletingSubstage } = useMutation({
    ...
    mutationFn: async (code) => {
      const response = await deleteSubStage(Number(search == null ? void 0 : search.case_id), code);
    ...
    onSuccess: (response) => {
      ...
      toast.success(response == null ? void 0 : response.message, {
        action: {
          label: "\u2715",
          onClick: () => toast.dismiss()
        }
    ...
    onError: (error) => {
      var _a2, _b;
      const errorMessage = ((_b = (_a2 = error == null ? void 0 : error.data) == null ? void 0 : _a2.errData) == null ? void 0 : _b.sub_stage[0]) || (error == null ? void 0 : error.message);
      setSubStageError(errorMessage);
    },
  ...
  const { mutate: mutateReorderSubStage, isPending: ReorderSubStage } = useMutation({
    mutationFn: async (payload) => {
      const response = await reorderSubStage(
        Number(search == null ? void 0 : search.case_id),
        payload
      );
      return response;
    },
  ...
  const handleAddSubStage = () => {
    const payload = {
      stage: search == null ? void 0 : search.stage,
  ...
  const handleBack = () => {
    navigate({ to: `/litigations/service/${search == null ? void 0 : search.case_id}/manage` });
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    caseStagesIsLoading ? /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx("div", { className: "w-full px-4 py-0 max-w-[1600px] mx-auto ", children: /* @__PURE__ */ jsxs("div", { className: "max-w-full bg-white rounded shadow-sm border p-4  border-gray-300", children: [
        /* @__PURE__ */ jsx("div", { className: "flex justify-between items-center", children: /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold", children: (_a = labelStage) == null ? void 0 : _a[search == null ? void 0 : search.stage] }) }),
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-gray-50 p-4 rounded space-y-2 max-h-[70vh] overflow-y-auto w-full lg:w-1/2", children: Array.isArray(subStagesList) && subStagesList.length > 0 ? /* @__PURE__ */ jsx(
            ReactSortable,
            {
              ...
              children: subStagesList.map((sub, index) => {
                ...
                const showActions = codeAfterHash.startsWith("Z") && (sub == null ? void 0 : sub.status) !== "completed";
...
//# sourceMappingURL=index-oMVSsaRz.mjs.map
