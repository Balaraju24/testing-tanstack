...
import { g as getAllDocsAPIV2, e as docsViewAPI } from './service-1g9dZr4o.mjs';
...
import { C as Card, a as CardHeader, b as CardContent } from './card-CfZVGcIr.mjs';
...
import { i as imageTypes } from './statusConstants-t7T05Rlh.mjs';
...
const FileCard = ({
  ...
  var _a;
  const isRecordUnread = (_a = file.doc_read_status) == null ? void 0 : _a.some(
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "w-full rounded-none mt-2 border-gray-200", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "w-full p-2 text-left flex justify-between items-center border-t border-gray-200", children: [
      /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [
        /* @__PURE__ */ jsx(TooltipTrigger, { children: /* @__PURE__ */ jsx("div", { className: "font-medium text-start text-xs", children: (file == null ? void 0 : file.file_name) ? sliceFilename(file == null ? void 0 : file.file_name, 10) : null }) }),
        /* @__PURE__ */ jsx(TooltipContent, { className: "bg-white border p-2 w-60", children: file == null ? void 0 : file.file_name })
      ] }) }),
      /* @__PURE__ */ jsx(
        "div",
        {
          className: "text-gray-500 hover:text-gray-700 flex items-center gap-2",
          onClick: () => handleDocumentClick(file == null ? void 0 : file.id),
...
const ServiceFiles = () => {
  ...
  const groupBySubstage = filesDetails == null ? void 0 : filesDetails.reduce(
    (group, file) => {
      var _a, _b;
      if (file.key === null || file.download_url === null) {
        return group;
      }
      const substage = (_a = file.case_sub_stage) != null ? _a : "Offline Payments";
      if (substage === "CSFG#ADDO" || substage === "QURI#MDSC") {
        const category = (_b = file.category) != null ? _b : "Uncategorized";
        if (!group[substage]) {
          group[substage] = {};
        }
  ...
  const handleDocumentClick = (documentId) => {
    const isRecordUnread = filesDetails == null ? void 0 : filesDetails.some(
      (record) => {
        var _a;
        return record.id === documentId && ((_a = record == null ? void 0 : record.doc_read_status) == null ? void 0 : _a.some(
          (item) => !item.is_seen && item.user_id === userType
        ));
      }
    );
    ...
    /* @__PURE__ */ jsx("div", { className: "h-[calc(100vh-155px)] relative", children: isLoading ? /* @__PURE__ */ jsx(LoadingComponent, { loading: isLoading, message: "Files..." }) : /* @__PURE__ */ jsx("div", { className: "p-4 h-full overflow-auto", children: Object.keys(groupBySubstage).length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center text-lg h-full flex items-center justify-center", children: /* @__PURE__ */ jsx(NoFilesData, { className: "w-1/3" }) }) : /* @__PURE__ */ jsx("div", { className: "space-y-4", children: Object.entries(groupBySubstage).map(([substage, group]) => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("h3", { className: "font-medium text-md leading-none capitalize", children: ((_b = (_a = caseStagesData == null ? void 0 : caseStagesData.sub_stages) == null ? void 0 : _a.find(
              (sub) => sub.code === substage
            )) == null ? void 0 : _b.title) || substage || "--" }),
...
export { ServiceFiles as S };
//# sourceMappingURL=ServiceFiles-VrHdN8Kc.mjs.map
