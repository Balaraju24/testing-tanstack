...
import { F as FileActions, U as UploadFileIcon } from './upload-file-icon-D1lM9Y8S.mjs';
import { F as FileDownload, A as ApproveLogo } from './approve-logo-BtPutrSX.mjs';
import { F as FileUpload, A as ApproveRejectDialog } from './ApproveRejectDialog-CbjX-vD1.mjs';
...
import { i as isSubStageCompleted, g as getSubStageTitle, a as fileSizeInMB } from './ManageCaseHeader-BFRej4X3.mjs';
...
import { U as UserFileIcon } from './userFileIcon-XAkFxF_N.mjs';
...
const UserGetCaseFiles = () => {
  ...
  const subStageTitle = getSubStageTitle(caseStagesData == null ? void 0 : caseStagesData.sub_stages, subStages);
  ...
  const {
    ...
    queryKey: ["user-file-details", params == null ? void 0 : params.service_id, stage, subStages],
    queryFn: async ({ signal }) => {
      ...
      try {
        ...
        const response = await getAllManageDocsAPI(
          params == null ? void 0 : params.service_id,
          queryParams,
          { signal }
        );
    ...
    enabled: !!(params == null ? void 0 : params.service_id),
  ...
  const { mutate: onConfirmDeleteFile, isPending: isDeleteLoading } = useMutation({
    ...
    mutationFn: async (docId) => {
      var _a;
      docId = (_a = filesDetails == null ? void 0 : filesDetails.find((item) => item.id === docId)) == null ? void 0 : _a.id;
  ...
  const onConfirmDelete = () => {
    ...
    onConfirmDeleteFile((deleteObj == null ? void 0 : deleteObj.id) || "");
  };
  ...
  const onConfirmDeletePlaceHolder = () => {
    if (isDeleteLoading) return;
    onConfirmDeletePlaceholder((deleteObj == null ? void 0 : deleteObj.id) || "");
  };
  const onConfirmApproveReject = () => {
    ...
    if (dialogType) {
      mutateApproveorRejectDocument({
        ...dialogType,
        notes: (_a = dialogType.notes) != null ? _a : ""
      });
    }
  };
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: `${(allRecords == null ? void 0 : allRecords.length) === 0 && (filesDetails == null ? void 0 : filesDetails.length) === 0 && (![
        "CSFG#SGCP",
        "CSFG#UDOC",
        "CSCR#JUGC",
        "CTPG#PYSC",
      ...
      children: [
        isFetching ? /* @__PURE__ */ jsx(
        ...
        ) : !filesDetails || (filesDetails == null ? void 0 : filesDetails.length) === 0 && (allRecords == null ? void 0 : allRecords.length) === 0 && ![
          "CSFG#SGCP",
          "CSFG#UDOC",
          "CSCR#JUGC",
          "CTPG#PYSC",
          "CSCR#ORDC",
          "ONBD#STFE"
        ].includes(subStages) || ["CSFG#SGCP", "CSFG#UDOC"].includes(subStages) && isCurrentStageCompleted && (filesDetails == null ? void 0 : filesDetails.length) === 0 && (allRecords == null ? void 0 : allRecords.length) === 0 ? /* @__PURE__ */ jsx("div", { className: "col-span-full text-center text-base text-gray-600 3xl:text-base h-full flex items-center justify-center", children: isCurrentStageCompleted ? `This stage is successfully completed. As the ${subStageTitle} document is optional, it may not be uploaded by your Advocate.` : `${subStageTitle} document will be uploaded by your Advocate.` }) : /* @__PURE__ */ jsx("div", { className: "w-full", children: !filesDetails && !isLoading ? null : /* @__PURE__ */ jsxs(
          "div",
          {
                  ...
                  file.download_url && /* @__PURE__ */ jsxs(Card, { className: "w-56 rounded-none overflow-hidden border shadow-none border-gray-300", children: [
                    ...
                    /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-col px-2 py-1", children: [
                      /* @__PURE__ */ jsx(
                        "div",
                        {
                          ...
                          title: file == null ? void 0 : file.file_name,
                          children: (file == null ? void 0 : file.file_name) ? sliceFilename(file == null ? void 0 : file.file_name, 25) : null
                        }
                      ),
                    ...
                    /* @__PURE__ */ jsxs(CardFooter, { className: "w-full p-1.5 text-left flex justify-between items-center mt-0", children: [
                      /* @__PURE__ */ jsxs("div", { className: "text-gray-500 text-[10px] smd:text-[11px] 4xl:text-xs flex items-center gap-2", children: [
                        formatDateWithTime(
                          (file == null ? void 0 : file.updated_at) || (file == null ? void 0 : file.created_at)
                        ),
...
export { UserGetCaseFiles as U };
//# sourceMappingURL=userGetCaseFiles-D4VE_Qg7.mjs.map
