...
const UserCNRNumberAllotment = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-full", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-2 relative w-full h-[calc(100%-60px)] overflow-auto", children: [
      (caseDetails == null ? void 0 : caseDetails.cnr_number) ? /* @__PURE__ */ jsx("div", { className: "flex gap-3", children: (caseDetails == null ? void 0 : caseDetails.cnr_number) && /* @__PURE__ */ jsxs("div", { className: "p-2 inline-block text-sm bg-gray-100 w-full", children: [
        /* @__PURE__ */ jsx("span", { className: "text-black ", children: "CNR Number :" }),
        " ",
        /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: caseDetails == null ? void 0 : caseDetails.cnr_number })
...
export { UserCNRNumberAllotment as default };
//# sourceMappingURL=index-CRAyhVoc.mjs.map
