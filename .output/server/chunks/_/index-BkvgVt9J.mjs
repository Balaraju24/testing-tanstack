...
import { g as getOrgServiceCasesCount } from './dashboard-uQmz2qHd.mjs';
import { u as useLocations, a as useOrganizationDropdown, C as ComboBox, b as CustomDateRangePicker, g as getIcon, c as useOrganizationsStats, I as INRFormatter } from './dashboard_queries-Cldy_CAd.mjs';
...
const Stats = ({
  ...
  const stats = allServices.map((service) => {
    const serviceData = serviceStats == null ? void 0 : serviceStats.find(
...
const RevenueStatistics = () => {
  ...
  const location2 = (_a = locationData == null ? void 0 : locationData.records) == null ? void 0 : _a.map((location3) => {
    return {
      id: location3.id,
  ...
  const allOrganizations = (_b = organizationsData == null ? void 0 : organizationsData.records) == null ? void 0 : _b.map((org) => {
    return {
      id: org.id,
  ...
  useEffect(() => {
    ...
    if (search.from || search.to) {
      navigate({
        to: location == null ? void 0 : location.pathname,
        search: void 0,
        replace: true
      });
    }
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-end  items-center gap-2", children: [
      /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsx(
        ComboBox,
        {
          ...
          value: allOrganizations == null ? void 0 : allOrganizations.find(
            (o) => o.id === searchOrganization
          ),
          onChange: (item) => setSearchOrganization(item == null ? void 0 : item.id),
      ...
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
        ComboBox,
        {
          ...
          value: location2 == null ? void 0 : location2.find((o) => o.id === selectedLocation),
          onChange: (item) => setSelectedLocation(item == null ? void 0 : item.id),
          defaultIcon: MapPin,
          className: "h-8 text-smd font-light border-gray-300",
          contentClassName: "bg-white rounded",
          isLoading,
...
//# sourceMappingURL=index-BkvgVt9J.mjs.map
