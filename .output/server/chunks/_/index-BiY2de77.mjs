...
import { g as getInitialView, T as TableViewIcon, G as GridViewIcon, E as EmptyCaseCard, C as CaseCard, v as viewStateHelper, V as VIEW_KEYS, A as AdvocateGroupAvatars, S as SettingsIcon } from './settings-icon-BFH7lXgA.mjs';
import { B as Button } from './router-e7zdrxGz.mjs';
import { g as getAllLitigationAPI } from './litigations-2Q1m8RsY.mjs';
...
import { c as capitalize } from './app-CEOvaEAI.mjs';
...
function LitigationsColumns() {
  ...
  const columns = [
      ...
      cell: (info) => {
        ...
        if (advocateCases.length === 1) {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsx(Avatar, { className: "w-7 h-7 flex items-center justify-center rounded-full bg-[#F7F7F7] border-none", children: (advocate == null ? void 0 : advocate.profile_pic) ? /* @__PURE__ */ jsx(
              AvatarImage,
              {
    ...
    },
    {
      accessorFn: (row) => {
        var _a;
        return ((_a = row.service) == null ? void 0 : _a.issue) || row.service_type || "";
      },
      id: "service_type",
  ...
  if (isAdvocate() || isManager() || isUser() || isAdmin()) {
    columns.splice(2, 0, {
      accessorFn: (row) => {
        var _a, _b;
        const firstName = ((_a = row.user) == null ? void 0 : _a.first_name) ? capitalize(row.user.first_name) : "";
        const lastName = ((_b = row.user) == null ? void 0 : _b.last_name) ? capitalize(row.user.last_name) : "";
        return {
...
const Litigations = ({
  ...
  const {
    ...
    queryFn: async () => {
      ...
      if ((response == null ? void 0 : response.status) === 200 || (response == null ? void 0 : response.status) === 201) {
        return (_a2 = response.data) == null ? void 0 : _a2.data;
      }
    },
    enabled: !!pagination.current_page,
    refetchOnWindowFocus: false
  });
  const showLitigationPagination = !isLoading && (litigationsData == null ? void 0 : litigationsData.pagination_info) && (litigationsData == null ? void 0 : litigationsData.records) && ((_b = litigationsData == null ? void 0 : litigationsData.records) == null ? void 0 : _b.length) > 0;
  ...
  return /* @__PURE__ */ jsx("div", { className: "overflow-hidden h-full relative", children: isClient && /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    tabsValue === "table" ? /* @__PURE__ */ jsx("div", { className: "", children: /* @__PURE__ */ jsx(
      TanStackTable,
      {
        data: (litigationsData == null ? void 0 : litigationsData.records) || [],
        columns: litigationsColumns,
        paginationDetails: litigationsData == null ? void 0 : litigationsData.pagination_info,
        getData: getCases,
        loading: isLoading,
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto", children: isLoading ? /* @__PURE__ */ jsx(EmptyCaseCard, {}) : (litigationsData == null ? void 0 : litigationsData.records) && ((_c = litigationsData == null ? void 0 : litigationsData.records) == null ? void 0 : _c.length) > 0 ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xll:grid-cols-4  2xl:gap-4", children: (_d = litigationsData == null ? void 0 : litigationsData.records) == null ? void 0 : _d.map((record) => /* @__PURE__ */ jsx(CaseCard, { record }, record.id)) }) : /* @__PURE__ */ jsx("div", { className: "flex justify-center items-center w-full h-120", children: /* @__PURE__ */ jsx(
        NoDataDisplay,
        {
          title: "litigations",
...
//# sourceMappingURL=index-BiY2de77.mjs.map
