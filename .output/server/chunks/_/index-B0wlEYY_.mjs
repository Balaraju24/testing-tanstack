...
import { E as EditNoteIcon } from './edit-note-icon-8syF9cj8.mjs';
import { M as MaleIcon, F as FemaleIcon } from './male-icon-DSAUjAFs.mjs';
...
function LawyerColumns() {
  ...
  return [
    ...
    {
      accessorFn: (row) => row.advocate_locations || [],
      id: "location",
      cell: (info) => {
          ...
          locations.slice(0, 1).map((loc) => {
            ...
            return /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: loc.location.name
              },
              loc.id
            );
          }),
          locations.length > 1 && /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [
            ...
            /* @__PURE__ */ jsx(
              TooltipContent,
              {
                ...
                children: locations.slice(1).map((loc) => {
                  const { background, color } = getColorByFirstLetter(
                    loc.location.name
                  );
                  return /* @__PURE__ */ jsx(
    ...
    },
    {
      ...
      cell: (info) => {
        var _a;
        return /* @__PURE__ */ jsx("span", { className: "text-xs", children: (_a = info.getValue()) != null ? _a : "--" });
      },
      width: "120px",
      maxWidth: "120px",
      minWidth: "120px",
...
const LawyersList = ({
  ...
  const { isAdmin } = useUserDetails();
  const lawyerColumns = LawyerColumns();
  const {
    isLoading,
    data: lawyersData,
    refetch
  } = useQuery({
    queryKey: ["advocate", pagination, debounceSearchString],
    queryFn: async () => {
      var _a;
      let queryParams = {
      ...
      if (response.status === 200 || response.status === 201) {
        const { records, pagination_info } = (_a = response == null ? void 0 : response.data) == null ? void 0 : _a.data;
    ...
    /* @__PURE__ */ jsx("div", { className: "flex justify-end items-center gap-x-8 mb-2", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-x-3", children: [
      ...
      !isAdmin() && /* @__PURE__ */ jsx(
        Button,
        {
          ...
          onClick: () => router.navigate({ to: "/create-advocate" }),
          children: /* @__PURE__ */ jsxs("span", { className: "flex items-center space-x-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "font-extralight", children: "Add Advocate" })
          ] })
        }
      )
    ] }) }),
...
const SplitComponent = LawyersList;

export { SplitComponent as component };
//# sourceMappingURL=index-B0wlEYY_.mjs.map
