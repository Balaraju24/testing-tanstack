...
import { P as PlusIcon } from './plus-icon-DkC55LLp.mjs';
import { A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent } from './index-Bb_5490h.mjs';
import { B as Button } from './router-e7zdrxGz.mjs';
import { b as deleteSingleDocAPI, e as documentApprovalAPI } from './fileUpload-BBm5-XTb.mjs';
...
import { ChevronDown, X, FileTextIcon } from 'lucide-react';
...
import { D as DocsCommentsSection, F as FilePdfIcon, d as FilesAudioIcon, c as Docsicon, b as FileSpreadsheatIcon, a as FileFilesIcon } from './DocsCommentsSection-1v4F6eR1.mjs';
...
function FileItem({
  ...
  const {
    ...
    onError: (error) => {
      var _a, _b, _c;
      toast.error(((_c = (_b = (_a = error == null ? void 0 : error.data) == null ? void 0 : _a.errData) == null ? void 0 : _b.notes) == null ? void 0 : _c[0]) || "An error occurred");
    }
  });
  ...
  if (!(file == null ? void 0 : file.file_name)) return null;
      ...
      /* @__PURE__ */ jsx(DialogTrigger, { className: "w-full cursor-pointer", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 [&_svg]:size-4 cursor-pointer", children: [
        ...
        /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [
          /* @__PURE__ */ jsx(TooltipTrigger, { children: /* @__PURE__ */ jsx("div", { className: "text-sm cursor-pointer", children: sliceFilename(
            file == null ? void 0 : file.file_name,
            UI_CONFIG.FILENAME_SLICE_LENGTH
          ) }) }),
          /* @__PURE__ */ jsx(TooltipContent, { className: "bg-white cursor-pointer", children: file == null ? void 0 : file.file_name })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-1 items-center", children: [
        (file == null ? void 0 : file.verification_status) === VERIFICATION_STATUS.APPROVED && /* @__PURE__ */ jsx("span", { className: "text-green-500", children: /* @__PURE__ */ jsx(ApprovedIcon, { className: "w-4 h-4" }) }),
        (file == null ? void 0 : file.verification_status) === VERIFICATION_STATUS.REJECTED && /* @__PURE__ */ jsx("span", { className: "text-red-500", children: /* @__PURE__ */ jsx(RejectIcon, {}) }),
        ...
        (file == null ? void 0 : file.verification_status) === VERIFICATION_STATUS.PENDING && !isCurrentStageCompleted && (file == null ? void 0 : file.uploaded_by) === (userDetails == null ? void 0 : userDetails.id) && /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [
...
function MissingDocuments({
  ...
  const { mutate: onConfirmDeleteFile, isPending: isDeleteLoading } = useMutation({
    ...
    mutationFn: async (docId) => {
      const doc = allDocsData == null ? void 0 : allDocsData.find((item) => item.id === docId);
      if (!(doc == null ? void 0 : doc.id)) throw new Error("Document ID not found");
  ...
  const {
    ...
    onError: (error) => {
      var _a, _b, _c;
      setAppRejError((_c = (_b = (_a = error == null ? void 0 : error.data) == null ? void 0 : _a.errData) == null ? void 0 : _b.notes) == null ? void 0 : _c[0]);
    }
  });
  ...
  const groupedByCategory = useMemo(() => {
    return Array.isArray(allDocsData) && (allDocsData == null ? void 0 : allDocsData.reduce((acc, file) => {
  ...
  useEffect(() => {
    if (allDocsData && groupedByCategory) {
      const itemsWithValidFiles = Object.entries(groupedByCategory).filter(([_, files]) => files.some((file) => file == null ? void 0 : file.file_name)).map(([category]) => category);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-full overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-4 relative h-[calc(100%-30px)] overflow-y-auto", children: [
      ...
      ) : (allDocsData == null ? void 0 : allDocsData.length) === 0 ? renderEmptyState() : /* @__PURE__ */ jsx(
        Accordion,
        {
          type: "multiple",
          ...
          children: Object.entries(groupedByCategory).map(([category, files]) => {
            const hasValidFiles = files.some((file) => file == null ? void 0 : file.file_name);
...
//# sourceMappingURL=index-D1zkU1mj.mjs.map
