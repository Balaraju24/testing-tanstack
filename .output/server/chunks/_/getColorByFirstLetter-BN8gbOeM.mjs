...
function getColorByFirstLetter(input) {
  ...
  const firstLetter = (_a = input == null ? void 0 : input.charAt(0)) == null ? void 0 : _a.toUpperCase();
  const letterIndex = (firstLetter == null ? void 0 : firstLetter.charCodeAt(0)) - 65;
...
export { getColorByFirstLetter as g };
//# sourceMappingURL=getColorByFirstLetter-BN8gbOeM.mjs.map
