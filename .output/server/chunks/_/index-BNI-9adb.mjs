...
const UserReview = () => {
  ...
  const { mutate: submitReview, isPending } = useMutation({
        ...
        review: [
          {
            ...
            rating: ratingNyayaTech != null ? ratingNyayaTech : null,
    ...
    onError: (error2) => {
      var _a;
      if ((error2 == null ? void 0 : error2.status) === 404 || (error2 == null ? void 0 : error2.status) === 401) {
        ...
        toast.error((_a = error2 == null ? void 0 : error2.data) == null ? void 0 : _a.message);
      }
    }
  });
  const handleSubmit = () => {
...
//# sourceMappingURL=index-BNI-9adb.mjs.map
