...
import { D as Dialog, d as DialogTrigger, a as DialogContent, e as DialogClose } from './dialog-CbaK730S.mjs';
...
import { l as addCaseBriefNotesAPI, m as draftingConsentAPI } from './manage-tW0NLyej.mjs';
import { a as labelSubStages } from './statusConstants-t7T05Rlh.mjs';
import { M as ManageCaseHeader, a as fileSizeInMB } from './ManageCaseHeader-BFRej4X3.mjs';
import { c as getSubStageStatuses, s as sliceFilename, f as formatDateWithTime } from './manage-CWSyPq63.mjs';
...
const DraftReview = ({
  ...
  const handleConsentChange = (isChecked) => {
    const trimmedRemarks = remarks == null ? void 0 : remarks.trim();
  ...
  useEffect(() => {
    ...
    setIsConsentProvided(
      allDocsData.every((record) => (record == null ? void 0 : record.is_consent_provided) === true)
    );
    setDocsApprove(
      allDocsData.some(
    ...
    isPrevSubStageCompleted ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "px-1 h-full ", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-auto relative p-2 h-[calc(100%-50px)] w-full", children: allDocsIsFetching ? /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            className: `w-full ${(allRecords == null ? void 0 : allRecords.length) === 0 ? "h-[calc(100%-20px)]" : ""} `,
            children: /* @__PURE__ */ jsx("div", { className: "h-full w-full", children: !Array.isArray(allDocsData) || allDocsData.length === 0 || allDocsData.every((file) => !file.download_url) && !allDocsIsFetching ? /* @__PURE__ */ jsx("div", { className: "col-span-full text-center text-lg h-full  flex items-center justify-center", children: "Draft document will upload by your Advocate" }) : /* @__PURE__ */ jsx("div", { className: "gap-4 h-full overflow-y-auto", children: (allDocsData == null ? void 0 : allDocsData.filter(
              (file) => file.verification_status === "APPROVED"
            ).length) > 0 ? allDocsData == null ? void 0 : allDocsData.map((file) => {
              ...
              return /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsx("div", { className: "py-1", children: file == null ? void 0 : file.category }),
                /* @__PURE__ */ jsxs(Card, { className: "w-56 rounded-none overflow-hidden border border-gray-200", children: [
                  ...
                  /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-col px-2 py-2", children: [
                    /* @__PURE__ */ jsx(TooltipProvider, { children: /* @__PURE__ */ jsxs(Tooltip, { children: [
                      /* @__PURE__ */ jsx(TooltipTrigger, { children: /* @__PURE__ */ jsx("div", { className: "font-medium text-start text-xs", children: (file == null ? void 0 : file.file_name) ? sliceFilename(
                        file == null ? void 0 : file.file_name,
                        25
                      ) : null }) }),
                      /* @__PURE__ */ jsx(TooltipContent, { className: "bg-white border border-gray-200 p-1 ml-10 w-3/4", children: file == null ? void 0 : file.file_name })
                    ] }) }),
...
export { DraftReview as default };
//# sourceMappingURL=index-DRv4eEFR.mjs.map
