...
import { c as cn, b as buttonVariants, B as Button } from './router-e7zdrxGz.mjs';
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...
      className: cn(
        ...
        "flex aspect-square size-auto w-full h-full flex-col gap-1 leading-none font-normal p-1 m-0.5",
        // Added m-0.5 for margin between buttons, reduced padding to p-1
...
//# sourceMappingURL=calendar-BN2MwFmY.mjs.map
