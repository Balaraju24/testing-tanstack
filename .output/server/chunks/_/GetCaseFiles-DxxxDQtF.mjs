...
import { A as ApproveDialog } from './complete-logo-DwVwh2_J.mjs';
import { A as ApproveRejectDialog, F as FileUpload } from './ApproveRejectDialog-CbjX-vD1.mjs';
import { L as LoadingComponent } from './Loading-DQypZbMn.mjs';
import { A as ApproveLogo, F as FileDownload } from './approve-logo-BtPutrSX.mjs';
import { b as deleteSingleDocAPI, c as deleteDocPlaceHolderAPI, e as documentApprovalAPI } from './fileUpload-BBm5-XTb.mjs';
import { f as getAllManageDocsAPI } from './manage-tW0NLyej.mjs';
import { Q as QUERY_KEYS, D as DRAFT_REVIEW_SUB_STAGES, L as LEGAL_NOTICE_SUB_STAGES, a as LEGAL_NOTICE_STAGES, b as TIMEOUT_DURATION, S as STATUS_MESSAGES, T as TOAST_MESSAGES } from './getCaseFilesConstants-BRQFWmkt.mjs';
import { i as isSubStageCompleted, a as fileSizeInMB } from './ManageCaseHeader-BFRej4X3.mjs';
...
import { U as UploadFileIcon, F as FileActions } from './upload-file-icon-D1lM9Y8S.mjs';
...
import { E as EditIcon } from './edit-icon-DqCvL3Yg.mjs';
import { R as RejectIcon } from './reject-icon-B4PaiBZt.mjs';
import { s as sliceFilename, f as formatDateWithTime } from './manage-CWSyPq63.mjs';
import { g as getFileIcon } from './FileIcon-DM2CMkXH.mjs';
import { D as Dialog, d as DialogTrigger, a as DialogContent, c as DialogTitle, e as DialogClose } from './dialog-CbaK730S.mjs';
import { D as DocsCommentsSection } from './DocsCommentsSection-1v4F6eR1.mjs';
...
const FilePreviewDialog = ({
  ...
  const finalDoc = (file == null ? void 0 : file.category) === "Final Document";
  ...
  const statusText = (file == null ? void 0 : file.verification_status) ? (file == null ? void 0 : file.verification_status.charAt(0).toUpperCase()) + (file == null ? void 0 : file.verification_status.slice(1).toLowerCase()) : "";
  const isImageFile = IMAGE_FILE_TYPES.includes(file == null ? void 0 : file.file_type);
  const handleReject = () => {
    var _a;
    rejAppDialog({
      docId: file.id,
      verification_status: VERIFICATION_STATUS.REJECTED,
      category: (_a = file == null ? void 0 : file.category) != null ? _a : ""
    });
  };
  const handleApprove = () => {
    onApprove({
      docId: file == null ? void 0 : file.id,
  ...
  const renderActionButtons = () => {
    ...
    return /* @__PURE__ */ jsx("p", { className: getStatusClass(file == null ? void 0 : file.verification_status), children: statusText });
  };
  const renderFileContent = () => {
    if (isImageFile) {
      return /* @__PURE__ */ jsx(
        "img",
        {
          src: file == null ? void 0 : file.download_url,
          alt: "Full Image",
      ...
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between w-full pb-2", children: [
            /* @__PURE__ */ jsx(DialogTitle, { children: /* @__PURE__ */ jsx("div", { className: "text-sm font-medium tracking-normal", children: file == null ? void 0 : file.file_name.replace(/\.[^/.]+$/, "") }) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: `w-${DIALOG_CONFIG.MAIN_CONTENT_WIDTH} px-2 py-2 border-r border-t border-gray-300 flex flex-col`, children: [
              /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end w-full mb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsx(
                  ...
                  {
                    file: {
                      key: file == null ? void 0 : file.key,
                      file_name: file == null ? void 0 : file.file_name
                    }
                  }
                )
              ] }) }),
    ...
    /* @__PURE__ */ jsxs(Card, { className: "w-56 rounded-none border border-gray-300 overflow-hidden ", children: [
            ...
            CardHeader,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "text-green-500 absolute top-4 right-3", children: [
                  (file == null ? void 0 : file.verification_status) === "APPROVED" && /* @__PURE__ */ jsx(ApprovedIcon, {}),
                  (file == null ? void 0 : file.verification_status) === "REJECTED" && /* @__PURE__ */ jsx(RejectIcon, {})
                ] }),
      ...
      /* @__PURE__ */ jsxs(CardFooter, { className: "w-full p-2 border-none text-left flex justify-between items-center border-t", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-gray-500 text-[10px] smd:text-[10px] flex items-center gap-2", children: [
          formatDateWithTime((file == null ? void 0 : file.updated_at) || (file == null ? void 0 : file.created_at)),
...
const FileList = ({
  ...
  const noticeDraftDocs = files == null ? void 0 : files.filter(
    (file) => (file == null ? void 0 : file.case_sub_stage) === "DLNT#DFNT" && (file == null ? void 0 : file.verification_status) === "APPROVED"
  );
  const noticeSendDocs = files == null ? void 0 : files.filter(
    (file) => (file == null ? void 0 : file.case_sub_stage) === "SLNT#SNNT"
  );
  let finalFiles = [];
  if (noticeDraftKey) {
...
const GetCaseFiles = ({ NoticeDraftKey, NoticeSentKey }) => {
  ...
  const onConfirmDelete = () => {
    if (isDeleteLoading || !(deleteObj == null ? void 0 : deleteObj.id)) return;
    ...
    queryFn: async ({ signal }) => {
      ...
      try {
        ...
        if ((response == null ? void 0 : response.status) === 200 || (response == null ? void 0 : response.status) === 201) {
          const data = (_b = (_a = response == null ? void 0 : response.data) == null ? void 0 : _a.data) == null ? void 0 : _b.records;
          setTimeout(() => {
            setLoading2(false);
          }, TIMEOUT_DURATION);
          return data;
  ...
  const { mutateAsync: onConfirmDeleteFile, isPending: isDeleteLoading } = useMutation({
    ...
    mutationFn: async (docId) => {
      var _a;
      docId = (_a = filesDetails == null ? void 0 : filesDetails.find((item) => (item == null ? void 0 : item.id) === docId)) == null ? void 0 : _a.id;
    ...
    onError: (error) => {
      var _a, _b;
      setDeleteError((_b = (_a = error == null ? void 0 : error.data) == null ? void 0 : _a.errData) == null ? void 0 : _b.reason[0]);
      getCaseFilesFetcher();
    }
  });
  const {
  ...
  const {
    ...
    onError: (error) => {
      var _a, _b;
      setAppRejError((_b = (_a = error == null ? void 0 : error.data) == null ? void 0 : _a.errData) == null ? void 0 : _b.notes[0]);
    }
  });
  const rejAppDialog = (params) => {
    setDialogType({
      docId: params == null ? void 0 : params.docId,
      verification_status: params == null ? void 0 : params.verification_status,
      category: (params == null ? void 0 : params.category) ? params == null ? void 0 : params.category : ""
    });
  };
  const onConfirmApproveReject = () => {
    ...
    if (dialogType) {
      mutateApproveorRejectDocument({
        ...dialogType,
        notes: (_a = dialogType == null ? void 0 : dialogType.notes) != null ? _a : ""
      });
    }
  };
  ...
  const rejectedFilesCount = Array.isArray(filesDetails) ? filesDetails.filter(
    (file) => (file == null ? void 0 : file.verification_status) === "REJECTED"
  ).length : 0;
  const validFilesCount = ((filesDetails == null ? void 0 : filesDetails.length) || 0) - rejectedFilesCount;
  const uploadedLegalNotice = (filesDetails == null ? void 0 : filesDetails.length) === 0 || (filesDetails == null ? void 0 : filesDetails.every(
    (file) => (file == null ? void 0 : file.verification_status) === "REJECTED"
  ));
  ...
  return /* @__PURE__ */ jsxs("div", { className: `p-1  ${isFetching || loading2 ? "h-full" : ""}`, children: [
    loading2 || isFetching ? /* @__PURE__ */ jsx(
      ...
      (filesDetails == null ? void 0 : filesDetails.some(
        (file) => DRAFT_REVIEW_SUB_STAGES.includes(file == null ? void 0 : file.case_sub_stage)
      )) && (filesDetails == null ? void 0 : filesDetails.some(
        (file) => (file == null ? void 0 : file.verification_status) === "APPROVED"
      )) && subStage === "CSFG#DREV" && /* @__PURE__ */ jsx("div", { className: "flex items-start mt-3 gap-2", children: !(filesDetails == null ? void 0 : filesDetails.some(
        (file) => (file == null ? void 0 : file.is_consent_provided) === true
      ...
      isCurrentStageCompleted && (allDocsData == null ? void 0 : allDocsData.length) === 0 && (allRecords == null ? void 0 : allRecords.length) === 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center mt-6", children: [
    ...
    /* @__PURE__ */ jsx(
      ApproveDialog,
      {
        ...
        onConfirm: (deleteObj == null ? void 0 : deleteObj.category) === null ? onConfirmDelete : onConfirmDeletePlaceHolder
      }
    ),
    /* @__PURE__ */ jsx(
      ApproveRejectDialog,
...
export { GetCaseFiles as G };
//# sourceMappingURL=GetCaseFiles-DxxxDQtF.mjs.map
