...
export default function Transfer({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <g id="g4515" transform="matrix(1.3333333,0,0,-1.3333333,0,682.66667)">
        <g id="g4517">
          <g id="g4519" clipPath="url(#clipPath4523)">
            <g id="g4525" transform="translate(170.5029,341.335)">
              <path
            ...
            <g id="g4529" transform="translate(450.0664,341.335)">
              <path
            ...
            <g id="g4533" transform="translate(326.3642,255.418)">
              <path
            ...
            <g id="g4537" transform="translate(176.3896,202.79)">
              <path
                d="M 0,0 H -120.344"
                style={{
                  fill: "none",
            ...
            <g id="g4541" transform="translate(176.3896,173.124)">
              <path
                d="M 0,0 H -120.344"
                style={{
                  fill: "none",
            ...
            <g id="g4545" transform="translate(176.3896,143.457)">
              <path
                d="M 0,0 H -120.344"
                style={{
                  fill: "none",
            ...
            <g id="g4549" transform="translate(456.4756,202.79)">
              <path
                d="M 0,0 H -120.345"
                style={{
                  fill: "none",
            ...
            <g id="g4553" transform="translate(456.4756,173.124)">
              <path
                d="M 0,0 H -120.345"
                style={{
                  fill: "none",
            ...
            <g id="g4557" transform="translate(456.4756,143.457)">
              <path
                d="M 0,0 H -120.345"
                style={{
                  fill: "none",
            ...
            <g id="g4561" transform="translate(72.8779,406.5137)">
              <path
            ...
            <g id="g4565" transform="translate(504.4599,262.4414)">
              <path
